...
<xsl:stylesheet version="2.0" xmlns:html="http://www.w3.org/TR/REC-html40" xmlns:image="http://www.google.com/schemas/sitemap-image/1.1" xmlns:sitemap="http://www.sitemaps.org/schemas/sitemap/0.9" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/">
		...
		<div id="content">
			<h1>XML Sitemap</h1>
			<p className="expl">
				Generated by <a href="https://aampipes.pk" target="_blank">aampipes.pk</a>, this is an XML Sitemap, meant for consumption by search engines.<br />
			...
			<xsl:if test="count(sitemap:sitemapindex/sitemap:sitemap) &gt; 0">
				...
				<table id="sitemap" cellpadding="3">
					...
					<xsl:for-each select="sitemap:sitemapindex/sitemap:sitemap">
						...
						<tr>
							<td>
								<a href="https://aampipes.pk/%7B$sitemapURL%7D"><xsl:value-of select="sitemap:loc"/></a>
							</td>
							<td>
