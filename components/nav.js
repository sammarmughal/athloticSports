                  ...
                  <div className="h-full flex flex-col py-6 bg-white shadow-xl overflow-y-scroll">
                    ...
                    <div className="mt-6 relative flex-1 px-4 sm:px-4">
                      ...
                      <ul className="1top-links items-center divide-y uppercase divide-slate-400 text-slate-700 divide-opacity-70 text-sm  font-bold   whitespace-nowrap">
                        ...
                        <li className="py-3">
                          SPORTS UNIFORM
                          <Link onClick={handleToggle} href="/products/rugby" title="Rugby Uniform" className="block mt-2 ml-4 text-blue-500">
                          ...
                          <Link onClick={handleToggle} href="/products/soccer" title="Soccer Uniform" className="block mt-2 ml-4 text-blue-500">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 inline -mt-1 mr-1">
                              <path fillRule="evenodd" d="M7.21 14.77a.75.75 0 01.02-1.06L11.168 10 7.23 6.29a.75.75 0 111.04-1.08l4.5 4.25a.75.75 0 010 1.08l-4.5 4.25a.75.75 0 01-1.06-.02z" clipRule="evenodd" /></svg>
                            Soccer
                          </Link>

                          <Link onClick={handleToggle} href="/products/basketball" title="Basketball Uniform" className="block mt-2 ml-4 text-blue-500">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 inline -mt-1 mr-1">
                              <path fillRule="evenodd" d="M7.21 14.77a.75.75 0 01.02-1.06L11.168 10 7.23 6.29a.75.75 0 111.04-1.08l4.5 4.25a.75.75 0 010 1.08l-4.5 4.25a.75.75 0 01-1.06-.02z" clipRule="evenodd" /></svg>
                            Basketball
                          </Link>

                          <Link onClick={handleToggle} href="/products/baseball" title="Baseball Uniform" className="block mt-2 ml-4 text-blue-500">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 inline -mt-1 mr-1">
                              <path fillRule="evenodd" d="M7.21 14.77a.75.75 0 01.02-1.06L11.168 10 7.23 6.29a.75.75 0 111.04-1.08l4.5 4.25a.75.75 0 010 1.08l-4.5 4.25a.75.75 0 01-1.06-.02z" clipRule="evenodd" /></svg>
                            Baseball
                          </Link>

                          <Link onClick={handleToggle} href="/products/ice-hockey" title="Ice Hockey Uniform" className="block mt-2 ml-4 text-blue-500">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 inline -mt-1 mr-1">
                              <path fillRule="evenodd" d="M7.21 14.77a.75.75 0 01.02-1.06L11.168 10 7.23 6.29a.75.75 0 111.04-1.08l4.5 4.25a.75.75 0 010 1.08l-4.5 4.25a.75.75 0 01-1.06-.02z" clipRule="evenodd" /></svg>
                            Ice Hockey
                          </Link>

                          <Link onClick={handleToggle} href="/products/volleyball" title="Volley Ball Uniform" className="block mt-2 ml-4 text-blue-500">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 inline -mt-1 mr-1">
                              <path fillRule="evenodd" d="M7.21 14.77a.75.75 0 01.02-1.06L11.168 10 7.23 6.29a.75.75 0 111.04-1.08l4.5 4.25a.75.75 0 010 1.08l-4.5 4.25a.75.75 0 01-1.06-.02z" clipRule="evenodd" /></svg>
                            Volley Ball
                          </Link>

                          <Link onClick={handleToggle} href="/products/crickEt" title="Cricket Uniform" className="block mt-2 ml-4 text-blue-500">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 inline -mt-1 mr-1">
                              <path fillRule="evenodd" d="M7.21 14.77a.75.75 0 01.02-1.06L11.168 10 7.23 6.29a.75.75 0 111.04-1.08l4.5 4.25a.75.75 0 010 1.08l-4.5 4.25a.75.75 0 01-1.06-.02z" clipRule="evenodd" /></svg>
                            Cricket
                          </Link>
                          ...
                          <Link onClick={handleToggle} href="/products/football" title="American Football Uniform" className="block mt-2 ml-4 text-blue-500">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 inline -mt-1 mr-1">
                              <path fillRule="evenodd" d="M7.21 14.77a.75.75 0 01.02-1.06L11.168 10 7.23 6.29a.75.75 0 111.04-1.08l4.5 4.25a.75.75 0 010 1.08l-4.5 4.25a.75.75 0 01-1.06-.02z" clipRule="evenodd" /></svg>
                            American Football
                          </Link>
                          ...
                          <Link onClick={handleToggle} href="/products/tennis" title="Tennis Uniform" className="block mt-2 ml-4 text-blue-500">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 inline -mt-1 mr-1">
                              <path fillRule="evenodd" d="M7.21 14.77a.75.75 0 01.02-1.06L11.168 10 7.23 6.29a.75.75 0 111.04-1.08l4.5 4.25a.75.75 0 010 1.08l-4.5 4.25a.75.75 0 01-1.06-.02z" clipRule="evenodd" /></svg>
                            Tennis
                          </Link>
                          ...
                          <Link onClick={handleToggle} href="/products/running" title="Running Uniform" className="block mt-2 ml-4 text-blue-500">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 inline -mt-1 mr-1">
                              <path fillRule="evenodd" d="M7.21 14.77a.75.75 0 01.02-1.06L11.168 10 7.23 6.29a.75.75 0 111.04-1.08l4.5 4.25a.75.75 0 010 1.08l-4.5 4.25a.75.75 0 01-1.06-.02z" clipRule="evenodd" /></svg>
                            Running
                          </Link>
