...
async function sendEmail(req, res) {
  try {
    ...
    await sendgrid.send({
      to: "aamgrw@gmail.com",
      from: "no-reply@aampipes.pk",  
      subject: `[Send Free Sample - AAM Pipes]`,
      ...
      <table>
        ...
        <tr style="font-size:18px; "><td style="width:10%; text-align:right; font-weight:bold; vertical-align:top;">Address :</td><td style="text-transform:capitalize; text-align:left;padding-left:5px;">${req.body.message} </td></tr>
        <tr><td></td><td style="text-align:center; padding-top:20px;"><img src="https://aampipes.pk/images/aam-pipes-logo.png"  style="height: 100px; text-align:center;width: auto; overflow: hidden;"/> </td></tr>
      </table>   
