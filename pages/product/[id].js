...
//             </Head>
//             <section>
//                 <div className="mt-10 flex px-4 sm:mt-16 sm:px-0 lg:mt-0">
...
//                     </div>
//                     <div className="mt-36 flex flex-col rounded-lg shadow-lg overflow-hidden hover:-translate-y-2 duration-300 w-[35%]">
