...
import content from '../productdetails.json';
  ...
  return (
    <>
      <Head>
        ...
        <title>Manufacturers of High-Quality Baseball Uniforms | Athlotic Sports</title>
        <meta
          name="title"
          content="Manufacturers of High-Quality Baseball Uniforms | Athlotic Sports"
        />
        <meta
          name="description"
          content="Leading manufacturers of top-tier baseball uniforms for athletes. Explore our premium athletic sports apparel collection today."
        />
      ...
      <MainHeader pageHeading="Custom Baseball Sports Uniform Supplier" />
