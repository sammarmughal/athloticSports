...
export default function Contact() {
  ...
  //     },
  //     body: JSON.stringify({
  //       html: '<h1>Hello, PDF!</h1><p>This is the content of the PDF.</p>',
  //     }),
  //   });
  ...
  <title>Contact Athlotic Sports | Sports items Manufacturer Pakistan</title>
            ...
            <div className="content-bx">
              <div className="block mt-2 text-gray-900">
                ...
                <h2 className="text-xl font-bold text-center mt-3">
                  Athlotic Sports Gujranwala - Pakistan
                </h2>
                <ul className="text-center">
                  <li>
                    <p className="mt-3 sm:text-base text-sm text-gray-900 ">
                      <svg
