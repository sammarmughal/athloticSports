                    ...
                    <form>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <div className="">
                                    <button type="submit" className="w-full py-3 btn-action rounded-full text-white font-semibold rounded hover:bg-blue-600 focus:outline-none focus:bg-blue-600">SIGNUP</button>
                                </div>
                                <div className="flex flex-col gap-4 justify-center items-center mt-6">
                                    <span className="mr-2">Or, signup with</span>
