...
export default function productDetailfitting() {
  let [categories] = useState({
    TRACKSUITS: [
      {
        id: 1,
        name: "Tracksuits Uniform Sample Product 1",
        detail: "Customize Your \Tracksuits Dress and order in bulk",
        imageSrc: "/images/products/tracksuits/1.webp",
        imageAlt: "\Tracksuits Uniform",
        features: "High Quality Wear",

      },
      {
        id: 2,
        name: "Tracksuits Uniform Sample Product 2",
        detail: "Customize Your \Tracksuits Dress and order in bulk",
        imageSrc: "/images/products/tracksuits/2.webp",
        imageAlt: "\Tracksuits Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 3,
        name: "Tracksuits Uniform Sample Product 3",
        detail: "Customize Your \Tracksuits Dress and order in bulk",
        imageSrc: "/images/products/tracksuits/3.webp",
        imageAlt: "\Tracksuits Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 4,
        name: "Tracksuits Uniform Sample Product 4",
        detail: "Customize Your \Tracksuits Dress and order in bulk",
        imageSrc: "/images/products/tracksuits/4.webp",
        imageAlt: "\Tracksuits Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 5,
        name: "Tracksuits Uniform Sample Product 5",
        detail: "Customize Your \Tracksuits Dress and order in bulk",
        imageSrc: "/images/products/tracksuits/5.webp",
        imageAlt: "\Tracksuits Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 6,
        name: "Tracksuits Uniform Sample Product 6",
        detail: "Customize Your \Tracksuits Dress and order in bulk",
        imageSrc: "/images/products/tracksuits/6.webp",
        imageAlt: "\Tracksuits Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 7,
        name: "Tracksuits Uniform Sample Product 7",
        detail: "Customize Your \Tracksuits Dress and order in bulk",
        imageSrc: "/images/products/tracksuits/7.webp",
        imageAlt: "\Tracksuits Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 8,
        name: "Tracksuits Uniform Sample Product 8",
        detail: "Customize Your \Tracksuits Dress and order in bulk",
        imageSrc: "/images/products/tracksuits/8.webp",
        imageAlt: "\Tracksuits Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 9,
        name: "Tracksuits Uniform Sample Product 9",
        detail: "Customize Your \Tracksuits Dress and order in bulk",
        imageSrc: "/images/products/tracksuits/9.webp",
        imageAlt: "\Tracksuits Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 10,
        name: "Tracksuits Uniform Sample Product 10",
        detail: "Customize Your \Tracksuits Dress and order in bulk",
        imageSrc: "/images/products/tracksuits/10.webp",
        imageAlt: "\Tracksuits Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 11,
        name: "Tracksuits Uniform Sample Product 11",
        detail: "Customize Your \Tracksuits Dress and order in bulk",
        imageSrc: "/images/products/tracksuits/11.webp",
        imageAlt: "\Tracksuits Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 12,
        name: "Tracksuits Uniform Sample Product 12",
        detail: "Customize Your \Tracksuits Dress and order in bulk",
        imageSrc: "/images/products/tracksuits/12.webp",
        imageAlt: "Tracksuits Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 13,
        name: "Tracksuits Uniform Sample Product 13",
        detail: "Customize Your Tracksuits Dress and order in bulk",
        imageSrc: "/images/products/tracksuits/13.webp",
        imageAlt: "Tracksuits Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 14,
        name: "Tracksuits Uniform Sample Product 14",
        detail: "Customize Your Tracksuits Dress and order in bulk",
        imageSrc: "/images/products/tracksuits/14.webp",
        imageAlt: "Tracksuits Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 15,
        name: "Tracksuits Uniform Sample Product 15",
        detail: "Customize Your Tracksuits Dress and order in bulk",
        imageSrc: "/images/products/tracksuits/15.webp",
        imageAlt: "Tracksuits Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 16,
        name: "Tracksuits Uniform Sample Product 16",
        detail: "Customize Your Tracksuits Dress and order in bulk",
        imageSrc: "/images/products/tracksuits/16.webp",
        imageAlt: "Tracksuits Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 17,
        name: "Tracksuits Uniform Sample Product 17",
        detail: "Customize Your Tracksuits Dress and order in bulk",
        imageSrc: "/images/products/tracksuits/17.webp",
        imageAlt: "Tracksuits Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 18,
        name: "Tracksuits Uniform Sample Product 18",
        detail: "Customize Your Tracksuits Dress and order in bulk",
        imageSrc: "/images/products/tracksuits/18.webp",
        imageAlt: "Tracksuits Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 19,
        name: "Tracksuits Uniform Sample Product 19",
        detail: "Customize Your Tracksuits Dress and order in bulk",
        imageSrc: "/images/products/tracksuits/19.webp",
        imageAlt: "Tracksuits Uniform",
        features: "High Quality Wear",
  ...
  return (
    <>
      <Head>
        ...
        <title>Manufacturers of High-Quality Track suits Uniforms | Athlotic Sports</title>
        <meta
          name="title"
          content="Manufacturers of High-Quality Track suits Uniforms | Athlotic Sports"
        />
        <meta
          name="description"
          content="Leading manufacturers of top-tier track suits uniforms for athletes. Explore our premium athletic sports apparel collection today."
        />
        ...
        <meta
          ...
          content="Leading manufacturers of top-tier tracksuits uniforms for athletes. Explore our premium athletic sports apparel collection today."
        />
      ...
      <MainHeader pageHeading="Custom Track suits Sports Uniform Supplier" />
