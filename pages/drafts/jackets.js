...
export default function productDetailfitting() {
  let [categories] = useState({
    JACKETS: [
      {
        id: 1,
        name: "Jackets Uniform Sample Product 1",
        detail: "Customize Your \Jackets Dress and order in bulk",
        imageSrc: "/images/products/jackets/1.webp",
        imageAlt: "\Jackets Uniform",
        features: "High Quality Wear",

      },
      {
        id: 2,
        name: "Jackets Uniform Sample Product 2",
        detail: "Customize Your \Jackets Dress and order in bulk",
        imageSrc: "/images/products/jackets/2.webp",
        imageAlt: "\Jackets Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 3,
        name: "Jackets Uniform Sample Product 3",
        detail: "Customize Your \Jackets Dress and order in bulk",
        imageSrc: "/images/products/jackets/3.webp",
        imageAlt: "\Jackets Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 4,
        name: "Jackets Uniform Sample Product 4",
        detail: "Customize Your \Jackets Dress and order in bulk",
        imageSrc: "/images/products/jackets/4.webp",
        imageAlt: "\Jackets Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 5,
        name: "Jackets Uniform Sample Product 5",
        detail: "Customize Your \Jackets Dress and order in bulk",
        imageSrc: "/images/products/jackets/5.webp",
        imageAlt: "\Jackets Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 6,
        name: "Jackets Uniform Sample Product 6",
        detail: "Customize Your \Jackets Dress and order in bulk",
        imageSrc: "/images/products/jackets/6.webp",
        imageAlt: "\Jackets Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 7,
        name: "Jackets Uniform Sample Product 7",
        detail: "Customize Your \Jackets Dress and order in bulk",
        imageSrc: "/images/products/jackets/7.webp",
        imageAlt: "\Jackets Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 8,
        name: "Jackets Uniform Sample Product 8",
        detail: "Customize Your \Jackets Dress and order in bulk",
        imageSrc: "/images/products/jackets/8.webp",
        imageAlt: "\Jackets Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 9,
        name: "Jackets Uniform Sample Product 9",
        detail: "Customize Your \Jackets Dress and order in bulk",
        imageSrc: "/images/products/jackets/9.webp",
        imageAlt: "\Jackets Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 10,
        name: "Jackets Uniform Sample Product 10",
        detail: "Customize Your \Jackets Dress and order in bulk",
        imageSrc: "/images/products/jackets/10.webp",
        imageAlt: "\Jackets Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 11,
        name: "Jackets Uniform Sample Product 11",
        detail: "Customize Your \Jackets Dress and order in bulk",
        imageSrc: "/images/products/jackets/11.webp",
        imageAlt: "\Jackets Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 12,
        name: "Jackets Uniform Sample Product 12",
        detail: "Customize Your \Jackets Dress and order in bulk",
        imageSrc: "/images/products/jackets/12.webp",
        imageAlt: "Jackets Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 13,
        name: "Jackets Uniform Sample Product 13",
        detail: "Customize Your Jackets Dress and order in bulk",
        imageSrc: "/images/products/jackets/13.webp",
        imageAlt: "Jackets Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 14,
        name: "Jackets Uniform Sample Product 14",
        detail: "Customize Your Jackets Dress and order in bulk",
        imageSrc: "/images/products/jackets/14.webp",
        imageAlt: "Jackets Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 15,
        name: "Jackets Uniform Sample Product 15",
        detail: "Customize Your Jackets Dress and order in bulk",
        imageSrc: "/images/products/jackets/15.webp",
        imageAlt: "Jackets Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 16,
        name: "Jackets Uniform Sample Product 16",
        detail: "Customize Your Jackets Dress and order in bulk",
        imageSrc: "/images/products/jackets/16.webp",
        imageAlt: "Jackets Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 17,
        name: "Jackets Uniform Sample Product 17",
        detail: "Customize Your Jackets Dress and order in bulk",
        imageSrc: "/images/products/jackets/17.webp",
        imageAlt: "Jackets Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 18,
        name: "Jackets Uniform Sample Product 18",
        detail: "Customize Your Jackets Dress and order in bulk",
        imageSrc: "/images/products/jackets/18.webp",
        imageAlt: "Jackets Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 19,
        name: "Jackets Uniform Sample Product 19",
        detail: "Customize Your Jackets Dress and order in bulk",
        imageSrc: "/images/products/jackets/19.webp",
        imageAlt: "Jackets Uniform",
        features: "High Quality Wear",
  ...
  return (
    <>
      <Head>
        ...
        <title>Manufacturers of High-Quality Jackets Uniforms | Athlotic Sports</title>
        <meta
          name="title"
          content="Manufacturers of High-Quality Jackets Uniforms | Athlotic Sports"
        />
        <meta
          name="description"
          content="Leading manufacturers of top-tier jackets uniforms for athletes. Explore our premium athletic sports apparel collection today."
        />
      ...
      <MainHeader pageHeading="Custom Jackets Sports Uniform Supplier" />
