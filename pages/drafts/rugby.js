...
export default function productDetailfitting() {
  let [categories] = useState({
    RUGBY: [
      {
        id: 1,
        name: "Rugby Uniform Sample Product 1",
        detail: "Customize Your Rugby Dress and order in bulk",
        imageSrc: "/images/products/rugby/1.webp",
        imageAlt: "Rugby Uniform",
        features: "High Quality Wear",

      },
      {
        id: 2,
        name: "Rugby Uniform Sample Product 2",
        detail: "Customize Your Rugby Dress and order in bulk",
        imageSrc: "/images/products/rugby/2.webp",
        imageAlt: "Rugby Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 3,
        name: "Rugby Uniform Sample Product 3",
        detail: "Customize Your Rugby Dress and order in bulk",
        imageSrc: "/images/products/rugby/3.webp",
        imageAlt: "Rugby Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 4,
        name: "Rugby Uniform Sample Product 4",
        detail: "Customize Your Rugby Dress and order in bulk",
        imageSrc: "/images/products/rugby/4.webp",
        imageAlt: "Rugby Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 5,
        name: "Rugby Uniform Sample Product 5",
        detail: "Customize Your Rugby Dress and order in bulk",
        imageSrc: "/images/products/rugby/5.webp",
        imageAlt: "Rugby Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 6,
        name: "Rugby Uniform Sample Product 6",
        detail: "Customize Your Rugby Dress and order in bulk",
        imageSrc: "/images/products/rugby/6.webp",
        imageAlt: "Rugby Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 7,
        name: "Rugby Uniform Sample Product 7",
        detail: "Customize Your Rugby Dress and order in bulk",
        imageSrc: "/images/products/rugby/7.webp",
        imageAlt: "Rugby Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 8,
        name: "Rugby Uniform Sample Product 8",
        detail: "Customize Your Rugby Dress and order in bulk",
        imageSrc: "/images/products/rugby/8.webp",
        imageAlt: "Rugby Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 9,
        name: "Rugby Uniform Sample Product 9",
        detail: "Customize Your Rugby Dress and order in bulk",
        imageSrc: "/images/products/rugby/9.webp",
        imageAlt: "Rugby Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 10,
        name: "Rugby Uniform Sample Product 10",
        detail: "Customize Your Rugby Dress and order in bulk",
        imageSrc: "/images/products/rugby/10.webp",
        imageAlt: "Rugby Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 11,
        name: "Rugby Uniform Sample Product 11",
        detail: "Customize Your Rugby Dress and order in bulk",
        imageSrc: "/images/products/rugby/11.webp",
        imageAlt: "Rugby Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 12,
        name: "Rugby Uniform Sample Product 12",
        detail: "Customize Your Rugby Dress and order in bulk",
        imageSrc: "/images/products/rugby/12.webp",
        imageAlt: "Rugby Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 13,
        name: "Rugby Uniform Sample Product 13",
        detail: "Customize Your Rugby Dress and order in bulk",
        imageSrc: "/images/products/rugby/13.webp",
        imageAlt: "Rugby Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 14,
        name: "Rugby Uniform Sample Product 14",
        detail: "Customize Your Rugby Dress and order in bulk",
        imageSrc: "/images/products/rugby/14.webp",
        imageAlt: "Rugby Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 15,
        name: "Rugby Uniform Sample Product 15",
        detail: "Customize Your Rugby Dress and order in bulk",
        imageSrc: "/images/products/rugby/15.webp",
        imageAlt: "Rugby Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 16,
        name: "Rugby Uniform Sample Product 16",
        detail: "Customize Your Rugby Dress and order in bulk",
        imageSrc: "/images/products/rugby/16.webp",
        imageAlt: "Rugby Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 17,
        name: "Rugby Uniform Sample Product 17",
        detail: "Customize Your Rugby Dress and order in bulk",
        imageSrc: "/images/products/rugby/17.webp",
        imageAlt: "Rugby Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 18,
        name: "Rugby Uniform Sample Product 18",
        detail: "Customize Your Rugby Dress and order in bulk",
        imageSrc: "/images/products/rugby/18.webp",
        imageAlt: "Rugby Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 19,
        name: "Rugby Uniform Sample Product 19",
        detail: "Customize Your Rugby Dress and order in bulk",
        imageSrc: "/images/products/rugby/19.webp",
        imageAlt: "Rugby Uniform",
        features: "High Quality Wear",
  ...
  return (
    <>
      <Head>
        ...
        <title>Manufacturers of High-Quality Rugby Uniforms | Athlotic Sports</title>
        <meta
          name="title"
          content="Manufacturers of High-Quality Rugby Uniforms | Athlotic Sports"
        />
        <meta
          name="description"
          content="Leading manufacturers of top-tier rugby uniforms for athletes. Explore our premium athletic sports apparel collection today."
        />
      ...
      <MainHeader pageHeading="Custom Rugby Sports Uniform Supplier" />
