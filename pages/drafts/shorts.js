...
export default function productDetailfitting() {
  let [categories] = useState({
    SHORTS: [
      {
        id: 1,
        name: "Shorts Uniform Sample Product 1",
        detail: "Customize Your Shorts Dress and order in bulk",
        imageSrc: "/images/products/shorts/1.webp",
        imageAlt: "Shorts Uniform",
        features: "High Quality Wear",

      },
      {
        id: 2,
        name: "Shorts Uniform Sample Product 2",
        detail: "Customize Your Shorts Dress and order in bulk",
        imageSrc: "/images/products/shorts/2.webp",
        imageAlt: "Shorts Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 3,
        name: "Shorts Uniform Sample Product 3",
        detail: "Customize Your Shorts Dress and order in bulk",
        imageSrc: "/images/products/shorts/3.webp",
        imageAlt: "Shorts Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 4,
        name: "Shorts Uniform Sample Product 4",
        detail: "Customize Your Shorts Dress and order in bulk",
        imageSrc: "/images/products/shorts/4.webp",
        imageAlt: "Shorts Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 5,
        name: "Shorts Uniform Sample Product 5",
        detail: "Customize Your Shorts Dress and order in bulk",
        imageSrc: "/images/products/shorts/5.webp",
        imageAlt: "Shorts Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 6,
        name: "Shorts Uniform Sample Product 6",
        detail: "Customize Your Shorts Dress and order in bulk",
        imageSrc: "/images/products/shorts/6.webp",
        imageAlt: "Shorts Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 7,
        name: "Shorts Uniform Sample Product 7",
        detail: "Customize Your Shorts Dress and order in bulk",
        imageSrc: "/images/products/shorts/7.webp",
        imageAlt: "Shorts Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 8,
        name: "Shorts Uniform Sample Product 8",
        detail: "Customize Your Shorts Dress and order in bulk",
        imageSrc: "/images/products/shorts/8.webp",
        imageAlt: "Shorts Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 9,
        name: "Shorts Uniform Sample Product 9",
        detail: "Customize Your Shorts Dress and order in bulk",
        imageSrc: "/images/products/shorts/9.webp",
        imageAlt: "Shorts Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 10,
        name: "Shorts Uniform Sample Product 10",
        detail: "Customize Your Shorts Dress and order in bulk",
        imageSrc: "/images/products/shorts/10.webp",
        imageAlt: "Shorts Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 11,
        name: "Shorts Uniform Sample Product 11",
        detail: "Customize Your Shorts Dress and order in bulk",
        imageSrc: "/images/products/shorts/11.webp",
        imageAlt: "Shorts Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 12,
        name: "Shorts Uniform Sample Product 12",
        detail: "Customize Your Shorts Dress and order in bulk",
        imageSrc: "/images/products/shorts/12.webp",
        imageAlt: "Shorts Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 13,
        name: "Shorts Uniform Sample Product 13",
        detail: "Customize Your Shorts Dress and order in bulk",
        imageSrc: "/images/products/shorts/13.webp",
        imageAlt: "Shorts Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 14,
        name: "Shorts Uniform Sample Product 14",
        detail: "Customize Your Shorts Dress and order in bulk",
        imageSrc: "/images/products/shorts/14.webp",
        imageAlt: "Shorts Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 15,
        name: "Shorts Uniform Sample Product 15",
        detail: "Customize Your Shorts Dress and order in bulk",
        imageSrc: "/images/products/shorts/15.webp",
        imageAlt: "Shorts Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 16,
        name: "Shorts Uniform Sample Product 16",
        detail: "Customize Your Shorts Dress and order in bulk",
        imageSrc: "/images/products/shorts/16.webp",
        imageAlt: "Shorts Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 17,
        name: "Shorts Uniform Sample Product 17",
        detail: "Customize Your Shorts Dress and order in bulk",
        imageSrc: "/images/products/shorts/17.webp",
        imageAlt: "Shorts Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 18,
        name: "Shorts Uniform Sample Product 18",
        detail: "Customize Your Shorts Dress and order in bulk",
        imageSrc: "/images/products/shorts/18.webp",
        imageAlt: "Shorts Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 19,
        name: "Shorts Uniform Sample Product 19",
        detail: "Customize Your Shorts Dress and order in bulk",
        imageSrc: "/images/products/shorts/19.webp",
        imageAlt: "Shorts Uniform",
        features: "High Quality Wear",
  ...
  return (
    <>
      <Head>
        ...
        <title>Manufacturers of High-Quality Shorts Uniforms | Athlotic Sports</title>
        <meta
          name="title"
          content="Manufacturers of High-Quality Shorts Uniforms | Athlotic Sports"
        />
        <meta
          name="description"
          content="Leading manufacturers of top-tier shorts uniforms for athletes. Explore our premium athletic sports apparel collection today."
        />
        ...
        <link rel="canonical" href="https://athlotic.com/shorts" />
        <link rel="preconnect" href="//www.google-analytics.com" as="script" />
        <meta name="google" content="notranslate" />
      </Head>

      <MainHeader pageHeading="Custom Shorts Sports Uniform Supplier" />
