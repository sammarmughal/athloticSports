...
export default function productDetailfitting() {
  let [categories] = useState({
    TENNIS: [
      {
        id: 1,
        name: "Tennis Uniform Sample Product 1",
        detail: "Customize Your Tennis Dress and order in bulk",
        imageSrc: "/images/products/tennis/1.webp",
        imageAlt: "Tennis Uniform",
        features: "High Quality Wear",

      },
      {
        id: 2,
        name: "Tennis Uniform Sample Product 2",
        detail: "Customize Your Tennis Dress and order in bulk",
        imageSrc: "/images/products/tennis/2.webp",
        imageAlt: "Tennis Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 3,
        name: "Tennis Uniform Sample Product 3",
        detail: "Customize Your Tennis Dress and order in bulk",
        imageSrc: "/images/products/tennis/3.webp",
        imageAlt: "Tennis Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 4,
        name: "Tennis Uniform Sample Product 4",
        detail: "Customize Your Tennis Dress and order in bulk",
        imageSrc: "/images/products/tennis/4.webp",
        imageAlt: "Tennis Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 5,
        name: "Tennis Uniform Sample Product 5",
        detail: "Customize Your Tennis Dress and order in bulk",
        imageSrc: "/images/products/tennis/5.webp",
        imageAlt: "Tennis Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 6,
        name: "Tennis Uniform Sample Product 6",
        detail: "Customize Your Tennis Dress and order in bulk",
        imageSrc: "/images/products/tennis/6.webp",
        imageAlt: "Tennis Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 7,
        name: "Tennis Uniform Sample Product 7",
        detail: "Customize Your Tennis Dress and order in bulk",
        imageSrc: "/images/products/tennis/7.webp",
        imageAlt: "Tennis Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 8,
        name: "Tennis Uniform Sample Product 8",
        detail: "Customize Your Tennis Dress and order in bulk",
        imageSrc: "/images/products/tennis/8.webp",
        imageAlt: "Tennis Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 9,
        name: "Tennis Uniform Sample Product 9",
        detail: "Customize Your Tennis Dress and order in bulk",
        imageSrc: "/images/products/tennis/9.webp",
        imageAlt: "Tennis Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 10,
        name: "Tennis Uniform Sample Product 10",
        detail: "Customize Your Tennis Dress and order in bulk",
        imageSrc: "/images/products/tennis/10.webp",
        imageAlt: "Tennis Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 11,
        name: "Tennis Uniform Sample Product 11",
        detail: "Customize Your Tennis Dress and order in bulk",
        imageSrc: "/images/products/tennis/11.webp",
        imageAlt: "Tennis Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 12,
        name: "Tennis Uniform Sample Product 12",
        detail: "Customize Your Tennis Dress and order in bulk",
        imageSrc: "/images/products/tennis/12.webp",
        imageAlt: "Tennis Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 13,
        name: "Tennis Uniform Sample Product 13",
        detail: "Customize Your Tennis Dress and order in bulk",
        imageSrc: "/images/products/tennis/13.webp",
        imageAlt: "Tennis Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 14,
        name: "Tennis Uniform Sample Product 14",
        detail: "Customize Your Tennis Dress and order in bulk",
        imageSrc: "/images/products/tennis/14.webp",
        imageAlt: "Tennis Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 15,
        name: "Tennis Uniform Sample Product 15",
        detail: "Customize Your Tennis Dress and order in bulk",
        imageSrc: "/images/products/tennis/15.webp",
        imageAlt: "Tennis Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 16,
        name: "Tennis Uniform Sample Product 16",
        detail: "Customize Your Tennis Dress and order in bulk",
        imageSrc: "/images/products/tennis/16.webp",
        imageAlt: "Tennis Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 17,
        name: "Tennis Uniform Sample Product 17",
        detail: "Customize Your Tennis Dress and order in bulk",
        imageSrc: "/images/products/tennis/17.webp",
        imageAlt: "Tennis Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 18,
        name: "Tennis Uniform Sample Product 18",
        detail: "Customize Your Tennis Dress and order in bulk",
        imageSrc: "/images/products/tennis/18.webp",
        imageAlt: "Tennis Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 19,
        name: "Tennis Uniform Sample Product 19",
        detail: "Customize Your Tennis Dress and order in bulk",
        imageSrc: "/images/products/tennis/19.webp",
        imageAlt: "Tennis Uniform",
        features: "High Quality Wear",
  ...
  return (
    <>
      <Head>
        ...
        <title>Manufacturers of High-Quality Tennis Uniforms | Athlotic Sports</title>
        <meta
          name="title"
          content="Manufacturers of High-Quality Tennis Uniforms | Athlotic Sports"
        />
        <meta
          name="description"
          content="Leading manufacturers of top-tier tennis uniforms for athletes. Explore our premium athletic sports apparel collection today."
        />
        ...
        <link rel="canonical" href="https://athlotic.com/tennis" />
        <link rel="preconnect" href="//www.google-analytics.com" as="script" />
        <meta name="google" content="notranslate" />
      </Head>

      <MainHeader pageHeading="Custom Tennis Sports Uniform Supplier" />
