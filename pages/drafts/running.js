...
export default function productDetailfitting() {
  let [categories] = useState({
    RUNNING: [
      {
        id: 1,
        name: "Running Uniform Sample Product 1",
        detail: "Customize Your \Running Dress and order in bulk",
        imageSrc: "/images/products/running/1.webp",
        imageAlt: "\Running Uniform",
        features: "High Quality Wear",

      },
      {
        id: 2,
        name: "Running Uniform Sample Product 2",
        detail: "Customize Your \Running Dress and order in bulk",
        imageSrc: "/images/products/running/2.webp",
        imageAlt: "\Running Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 3,
        name: "Running Uniform Sample Product 3",
        detail: "Customize Your \Running Dress and order in bulk",
        imageSrc: "/images/products/running/3.webp",
        imageAlt: "\Running Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 4,
        name: "Running Uniform Sample Product 4",
        detail: "Customize Your \Running Dress and order in bulk",
        imageSrc: "/images/products/running/4.webp",
        imageAlt: "\Running Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 5,
        name: "Running Uniform Sample Product 5",
        detail: "Customize Your \Running Dress and order in bulk",
        imageSrc: "/images/products/running/5.webp",
        imageAlt: "\Running Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 6,
        name: "Running Uniform Sample Product 6",
        detail: "Customize Your \Running Dress and order in bulk",
        imageSrc: "/images/products/running/6.webp",
        imageAlt: "\Running Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 7,
        name: "Running Uniform Sample Product 7",
        detail: "Customize Your \Running Dress and order in bulk",
        imageSrc: "/images/products/running/7.webp",
        imageAlt: "\Running Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 8,
        name: "Running Uniform Sample Product 8",
        detail: "Customize Your \Running Dress and order in bulk",
        imageSrc: "/images/products/running/8.webp",
        imageAlt: "\Running Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 9,
        name: "Running Uniform Sample Product 9",
        detail: "Customize Your \Running Dress and order in bulk",
        imageSrc: "/images/products/running/9.webp",
        imageAlt: "\Running Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 10,
        name: "Running Uniform Sample Product 10",
        detail: "Customize Your \Running Dress and order in bulk",
        imageSrc: "/images/products/running/10.webp",
        imageAlt: "\Running Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 11,
        name: "Running Uniform Sample Product 11",
        detail: "Customize Your \Running Dress and order in bulk",
        imageSrc: "/images/products/running/11.webp",
        imageAlt: "\Running Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 12,
        name: "Running Uniform Sample Product 12",
        detail: "Customize Your \Running Dress and order in bulk",
        imageSrc: "/images/products/running/12.webp",
        imageAlt: "Running Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 13,
        name: "Running Uniform Sample Product 13",
        detail: "Customize Your Running Dress and order in bulk",
        imageSrc: "/images/products/running/13.webp",
        imageAlt: "Running Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 14,
        name: "Running Uniform Sample Product 14",
        detail: "Customize Your Running Dress and order in bulk",
        imageSrc: "/images/products/running/14.webp",
        imageAlt: "Running Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 15,
        name: "Running Uniform Sample Product 15",
        detail: "Customize Your Running Dress and order in bulk",
        imageSrc: "/images/products/running/15.webp",
        imageAlt: "Running Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 16,
        name: "Running Uniform Sample Product 16",
        detail: "Customize Your Running Dress and order in bulk",
        imageSrc: "/images/products/running/16.webp",
        imageAlt: "Running Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 17,
        name: "Running Uniform Sample Product 17",
        detail: "Customize Your Running Dress and order in bulk",
        imageSrc: "/images/products/running/17.webp",
        imageAlt: "Running Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 18,
        name: "Running Uniform Sample Product 18",
        detail: "Customize Your Running Dress and order in bulk",
        imageSrc: "/images/products/running/18.webp",
        imageAlt: "Running Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 19,
        name: "Running Uniform Sample Product 19",
        detail: "Customize Your Running Dress and order in bulk",
        imageSrc: "/images/products/running/19.webp",
        imageAlt: "Running Uniform",
        features: "High Quality Wear",
  ...
  return (
    <>
      <Head>
        ...
        <title>Manufacturers of High-Quality Running Uniforms | Athlotic Sports</title>
        <meta
          name="title"
          content="Manufacturers of High-Quality Running Uniforms | Athlotic Sports"
        />
        <meta
          name="description"
          content="Leading manufacturers of top-tier running uniforms for athletes. Explore our premium athletic sports apparel collection today."
        />
      ...
      <MainHeader pageHeading="Custom Running Sports Uniform Supplier" />
