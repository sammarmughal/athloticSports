...
export default function productDetailfitting() {
  let [categories] = useState({
    VOLLEYBALL: [
      {
        id: 1,
        name: "Volley-ball Uniform Sample Product 1",
        detail: "Customize Your \Volley-ball Dress and order in bulk",
        imageSrc: "/images/products/volley-ball/1.webp",
        imageAlt: "\Volley-ball Uniform",
        features: "High Quality Wear",

      },
      {
        id: 2,
        name: "Volley-ball Uniform Sample Product 2",
        detail: "Customize Your \Volley-ball Dress and order in bulk",
        imageSrc: "/images/products/volley-ball/2.webp",
        imageAlt: "\Volley-ball Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 3,
        name: "Volley-ball Uniform Sample Product 3",
        detail: "Customize Your \Volley-ball Dress and order in bulk",
        imageSrc: "/images/products/volley-ball/3.webp",
        imageAlt: "\Volley-ball Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 4,
        name: "Volley-ball Uniform Sample Product 4",
        detail: "Customize Your \Volley-ball Dress and order in bulk",
        imageSrc: "/images/products/volley-ball/4.webp",
        imageAlt: "\Volley-ball Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 5,
        name: "Volley-ball Uniform Sample Product 5",
        detail: "Customize Your \Volley-ball Dress and order in bulk",
        imageSrc: "/images/products/volley-ball/5.webp",
        imageAlt: "\Volley-ball Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 6,
        name: "Volley-ball Uniform Sample Product 6",
        detail: "Customize Your \Volley-ball Dress and order in bulk",
        imageSrc: "/images/products/volley-ball/6.webp",
        imageAlt: "\Volley-ball Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 7,
        name: "Volley-ball Uniform Sample Product 7",
        detail: "Customize Your \Volley-ball Dress and order in bulk",
        imageSrc: "/images/products/volley-ball/7.webp",
        imageAlt: "\Volley-ball Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 8,
        name: "Volley-ball Uniform Sample Product 8",
        detail: "Customize Your \Volley-ball Dress and order in bulk",
        imageSrc: "/images/products/volley-ball/8.webp",
        imageAlt: "\Volley-ball Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 9,
        name: "Volley-ball Uniform Sample Product 9",
        detail: "Customize Your \Volley-ball Dress and order in bulk",
        imageSrc: "/images/products/volley-ball/9.webp",
        imageAlt: "\Volley-ball Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 10,
        name: "Volley-ball Uniform Sample Product 10",
        detail: "Customize Your \Volley-ball Dress and order in bulk",
        imageSrc: "/images/products/volley-ball/10.webp",
        imageAlt: "\Volley-ball Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 11,
        name: "Volley-ball Uniform Sample Product 11",
        detail: "Customize Your \Volley-ball Dress and order in bulk",
        imageSrc: "/images/products/volley-ball/11.webp",
        imageAlt: "\Volley-ball Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 12,
        name: "Volley-ball Uniform Sample Product 12",
        detail: "Customize Your \Volley-ball Dress and order in bulk",
        imageSrc: "/images/products/volley-ball/12.webp",
        imageAlt: "Volley-ball Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 13,
        name: "Volley-ball Uniform Sample Product 13",
        detail: "Customize Your Volley-ball Dress and order in bulk",
        imageSrc: "/images/products/volley-ball/13.webp",
        imageAlt: "Volley-ball Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 14,
        name: "Volley-ball Uniform Sample Product 14",
        detail: "Customize Your Volley-ball Dress and order in bulk",
        imageSrc: "/images/products/volley-ball/14.webp",
        imageAlt: "Volley-ball Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 15,
        name: "Volley-ball Uniform Sample Product 15",
        detail: "Customize Your Volley-ball Dress and order in bulk",
        imageSrc: "/images/products/volley-ball/15.webp",
        imageAlt: "Volley-ball Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 16,
        name: "Volley-ball Uniform Sample Product 16",
        detail: "Customize Your Volley-ball Dress and order in bulk",
        imageSrc: "/images/products/volley-ball/16.webp",
        imageAlt: "Volley-ball Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 17,
        name: "Volley-ball Uniform Sample Product 17",
        detail: "Customize Your Volley-ball Dress and order in bulk",
        imageSrc: "/images/products/volley-ball/17.webp",
        imageAlt: "Volley-ball Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 18,
        name: "Volley-ball Uniform Sample Product 18",
        detail: "Customize Your Volley-ball Dress and order in bulk",
        imageSrc: "/images/products/volley-ball/18.webp",
        imageAlt: "Volley-ball Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 19,
        name: "Volley-ball Uniform Sample Product 19",
        detail: "Customize Your Volley-ball Dress and order in bulk",
        imageSrc: "/images/products/volley-ball/19.webp",
        imageAlt: "Volley-ball Uniform",
        features: "High Quality Wear",
  ...
  return (
    <>
      <Head>
        ...
        <title>Manufacturers of High-Quality Volley ball Uniforms | Athlotic Sports</title>
        <meta
          name="title"
          content="Manufacturers of High-Quality Volley ball Uniforms | Athlotic Sports"
        />
        <meta
          name="description"
          content="Leading manufacturers of top-tier volley ball uniforms for athletes. Explore our premium athletic sports apparel collection today."
        />
      ...
      <MainHeader pageHeading="Custom Volley ball Sports Uniform Supplier" />
