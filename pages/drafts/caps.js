...
export default function productDetailfitting() {
  let [categories] = useState({
    CAPS: [
      {
        id: 1,
        name: "Caps Uniform Sample Product 1",
        detail: "Customize Your \Caps Dress and order in bulk",
        imageSrc: "/images/products/caps/1.webp",
        imageAlt: "\Caps Uniform",
        features: "High Quality Wear",

      },
      {
        id: 2,
        name: "Caps Uniform Sample Product 2",
        detail: "Customize Your \Caps Dress and order in bulk",
        imageSrc: "/images/products/caps/2.webp",
        imageAlt: "\Caps Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 3,
        name: "Caps Uniform Sample Product 3",
        detail: "Customize Your \Caps Dress and order in bulk",
        imageSrc: "/images/products/caps/3.webp",
        imageAlt: "\Caps Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 4,
        name: "Caps Uniform Sample Product 4",
        detail: "Customize Your \Caps Dress and order in bulk",
        imageSrc: "/images/products/caps/4.webp",
        imageAlt: "\Caps Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 5,
        name: "Caps Uniform Sample Product 5",
        detail: "Customize Your \Caps Dress and order in bulk",
        imageSrc: "/images/products/caps/5.webp",
        imageAlt: "\Caps Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 6,
        name: "Caps Uniform Sample Product 6",
        detail: "Customize Your \Caps Dress and order in bulk",
        imageSrc: "/images/products/caps/6.webp",
        imageAlt: "\Caps Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 7,
        name: "Caps Uniform Sample Product 7",
        detail: "Customize Your \Caps Dress and order in bulk",
        imageSrc: "/images/products/caps/7.webp",
        imageAlt: "\Caps Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 8,
        name: "Caps Uniform Sample Product 8",
        detail: "Customize Your \Caps Dress and order in bulk",
        imageSrc: "/images/products/caps/8.webp",
        imageAlt: "\Caps Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 9,
        name: "Caps Uniform Sample Product 9",
        detail: "Customize Your \Caps Dress and order in bulk",
        imageSrc: "/images/products/caps/9.webp",
        imageAlt: "\Caps Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 10,
        name: "Caps Uniform Sample Product 10",
        detail: "Customize Your \Caps Dress and order in bulk",
        imageSrc: "/images/products/caps/10.webp",
        imageAlt: "\Caps Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 11,
        name: "Caps Uniform Sample Product 11",
        detail: "Customize Your \Caps Dress and order in bulk",
        imageSrc: "/images/products/Caps/11.webp",
        imageAlt: "\Caps Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 12,
        name: "Caps Uniform Sample Product 12",
        detail: "Customize Your \Caps Dress and order in bulk",
        imageSrc: "/images/products/caps/12.webp",
        imageAlt: "Caps Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 13,
        name: "Caps Uniform Sample Product 13",
        detail: "Customize Your Caps Dress and order in bulk",
        imageSrc: "/images/products/caps/13.webp",
        imageAlt: "Caps Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 14,
        name: "Caps Uniform Sample Product 14",
        detail: "Customize Your Caps Dress and order in bulk",
        imageSrc: "/images/products/caps/14.webp",
        imageAlt: "Caps Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 15,
        name: "Caps Uniform Sample Product 15",
        detail: "Customize Your Caps Dress and order in bulk",
        imageSrc: "/images/products/caps/15.webp",
        imageAlt: "Caps Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 16,
        name: "Caps Uniform Sample Product 16",
        detail: "Customize Your Caps Dress and order in bulk",
        imageSrc: "/images/products/caps/16.webp",
        imageAlt: "Caps Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 17,
        name: "Caps Uniform Sample Product 17",
        detail: "Customize Your Caps Dress and order in bulk",
        imageSrc: "/images/products/caps/17.webp",
        imageAlt: "Caps Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 18,
        name: "Caps Uniform Sample Product 18",
        detail: "Customize Your Caps Dress and order in bulk",
        imageSrc: "/images/products/caps/18.webp",
        imageAlt: "Caps Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 19,
        name: "Caps Uniform Sample Product 19",
        detail: "Customize Your Caps Dress and order in bulk",
        imageSrc: "/images/products/caps/19.webp",
        imageAlt: "Caps Uniform",
        features: "High Quality Wear",
  ...
  return (
    <>
      <Head>
        ...
        <title>Manufacturers of High-Quality Caps Uniforms | Athlotic Sports</title>
        <meta
          name="title"
          content="Manufacturers of High-Quality Caps Uniforms | Athlotic Sports"
        />
        <meta
          name="description"
          content="Leading manufacturers of top-tier caps uniforms for athletes. Explore our premium athletic sports apparel collection today."
        />
      ...
      <MainHeader pageHeading="Custom Caps Sports Uniform Supplier" />
