...
export default function productDetailfitting() {
  let [categories] = useState({
    SPORTSBAG: [
      {
        id: 1,
        name: "Sports-bag Sample Product 1",
        detail: "Customize Your \Sports-bag Dress and order in bulk",
        imageSrc: "/images/products/sports-bag/1.webp",
        imageAlt: "\Sports-bag",
      ...
      {
        id: 2,
        name: "Sports-bag Sample Product 2",
        detail: "Customize Your \Sports-bag Dress and order in bulk",
        imageSrc: "/images/products/sports-bag/2.webp",
        imageAlt: "\Sports-bag",
        features: "High Quality Wear",
      ...
      {
        id: 3,
        name: "Sports-bag Sample Product 3",
        detail: "Customize Your \Sports-bag Dress and order in bulk",
        imageSrc: "/images/products/sports-bag/3.webp",
        imageAlt: "\Sports-bag",
        features: "High Quality Wear",
      ...
      {
        id: 4,
        name: "Sports-bag Sample Product 4",
        detail: "Customize Your \Sports-bag Dress and order in bulk",
        imageSrc: "/images/products/sports-bag/4.webp",
        imageAlt: "\Sports-bag",
        features: "High Quality Wear",
      ...
      {
        id: 5,
        name: "Sports-bag Sample Product 5",
        detail: "Customize Your \Sports-bag Dress and order in bulk",
        imageSrc: "/images/products/sports-bag/5.webp",
        imageAlt: "\Sports-bag",
        features: "High Quality Wear",
      ...
      {
        id: 6,
        name: "Sports-bag Sample Product 6",
        detail: "Customize Your \Sports-bag Dress and order in bulk",
        imageSrc: "/images/products/sports-bag/6.webp",
        imageAlt: "\Sports-bag",
        features: "High Quality Wear",
      ...
      {
        id: 7,
        name: "Sports-bag Sample Product 7",
        detail: "Customize Your \Sports-bag Dress and order in bulk",
        imageSrc: "/images/products/sports-bag/7.webp",
        imageAlt: "\Sports-bag",
        features: "High Quality Wear",
      ...
      {
        id: 8,
        name: "Sports-bag Sample Product 8",
        detail: "Customize Your \Sports-bag Dress and order in bulk",
        imageSrc: "/images/products/sports-bag/8.webp",
        imageAlt: "\Sports-bag",
        features: "High Quality Wear",
      ...
      {
        id: 9,
        name: "Sports-bag Sample Product 9",
        detail: "Customize Your \Sports-bag Dress and order in bulk",
        imageSrc: "/images/products/sports-bag/9.webp",
        imageAlt: "\Sports-bag",
        features: "High Quality Wear",
      ...
      {
        id: 10,
        name: "Sports-bag Sample Product 10",
        detail: "Customize Your \Sports-bag Dress and order in bulk",
        imageSrc: "/images/products/sports-bag/10.webp",
        imageAlt: "\Sports-bag",
        features: "High Quality Wear",
      ...
      {
        id: 11,
        name: "Sports-bag Sample Product 11",
        detail: "Customize Your \Sports-bag Dress and order in bulk",
        imageSrc: "/images/products/sports-bag/11.webp",
        imageAlt: "\Sports-bag",
        features: "High Quality Wear",
      ...
      {
        id: 12,
        name: "Sports-bag Sample Product 12",
        detail: "Customize Your \Sports-bag Dress and order in bulk",
        imageSrc: "/images/products/sports-bag/12.webp",
        imageAlt: "Sports-bag",
        features: "High Quality Wear",
      ...
      {
        id: 13,
        name: "Sports-bag Sample Product 13",
        detail: "Customize Your Sports-bag Dress and order in bulk",
        imageSrc: "/images/products/sports-bag/13.webp",
        imageAlt: "Sports-bag",
        features: "High Quality Wear",
      ...
      {
        id: 14,
        name: "Sports-bag Sample Product 14",
        detail: "Customize Your Sports-bag Dress and order in bulk",
        imageSrc: "/images/products/sports-bag/14.webp",
        imageAlt: "Sports-bag",
        features: "High Quality Wear",
      ...
      {
        id: 15,
        name: "Sports-bag Sample Product 15",
        detail: "Customize Your Sports-bag Dress and order in bulk",
        imageSrc: "/images/products/sports-bag/15.webp",
        imageAlt: "Sports-bag",
        features: "High Quality Wear",
      ...
      {
        id: 16,
        name: "Sports-bag Sample Product 16",
        detail: "Customize Your Sports-bag Dress and order in bulk",
        imageSrc: "/images/products/sports-bag/16.webp",
        imageAlt: "Sports-bag",
        features: "High Quality Wear",
      ...
      {
        id: 17,
        name: "Sports-bag Sample Product 17",
        detail: "Customize Your Sports-bag Dress and order in bulk",
        imageSrc: "/images/products/sports-bag/17.webp",
        imageAlt: "Sports-bag",
        features: "High Quality Wear",
      ...
      {
        id: 18,
        name: "Sports-bag Sample Product 18",
        detail: "Customize Your Sports-bag Dress and order in bulk",
        imageSrc: "/images/products/sports-bag/18.webp",
        imageAlt: "Sports-bag",
        features: "High Quality Wear",
      ...
      {
        id: 19,
        name: "Sports-bag Sample Product 19",
        detail: "Customize Your Sports-bag Dress and order in bulk",
        imageSrc: "/images/products/sports-bag/19.webp",
        imageAlt: "Sports-bag",
        features: "High Quality Wear",
  ...
  return (
    <>
      <Head>
        ...
        <title>Manufacturers of High-Quality Sports-bag Uniforms | Athlotic Sports</title>
        <meta
          name="title"
          content="Manufacturers of High-Quality Sports-bag Uniforms | Athlotic Sports"
        />
        <meta
          name="description"
          content="Leading manufacturers of top-tier sports-bag uniforms for athletes. Explore our premium athletic sports apparel collection today."
        />
      ...
      <MainHeader pageHeading="Custom Sports-bag Sports Uniform Supplier" />
