...
export default function productDetailfitting() {
  let [categories] = useState({
    GYMWEAR: [
      {
        id: 1,
        name: "Gym-wear Uniform Sample Product 1",
        detail: "Customize Your Gym-wear Dress and order in bulk",
        imageSrc: "/images/products/gym-wear/1.webp",
        imageAlt: "Gym-wear Uniform",
        features: "High Quality Wear",

      },
      {
        id: 2,
        name: "Gym-wear Uniform Sample Product 2",
        detail: "Customize Your Gym-wear Dress and order in bulk",
        imageSrc: "/images/products/gym-wear/2.webp",
        imageAlt: "Gym-wear Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 3,
        name: "Gym-wear Uniform Sample Product 3",
        detail: "Customize Your Gym-wear Dress and order in bulk",
        imageSrc: "/images/products/gym-wear/3.webp",
        imageAlt: "Gym-wear Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 4,
        name: "Gym-wear Uniform Sample Product 4",
        detail: "Customize Your Gym-wear Dress and order in bulk",
        imageSrc: "/images/products/gym-wear/4.webp",
        imageAlt: "Gym-wear Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 5,
        name: "Gym-wear Uniform Sample Product 5",
        detail: "Customize Your Gym-wear Dress and order in bulk",
        imageSrc: "/images/products/gym-wear/5.webp",
        imageAlt: "Gym-wear Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 6,
        name: "Gym-wear Uniform Sample Product 6",
        detail: "Customize Your Gym-wear Dress and order in bulk",
        imageSrc: "/images/products/gym-wear/6.webp",
        imageAlt: "Gym-wear Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 7,
        name: "Gym-wear Uniform Sample Product 7",
        detail: "Customize Your Gym-wear Dress and order in bulk",
        imageSrc: "/images/products/gym-wear/7.webp",
        imageAlt: "Gym-wear Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 8,
        name: "Gym-wear Uniform Sample Product 8",
        detail: "Customize Your Gym-wear Dress and order in bulk",
        imageSrc: "/images/products/gym-wear/8.webp",
        imageAlt: "Gym-wear Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 9,
        name: "Gym-wear Uniform Sample Product 9",
        detail: "Customize Your Gym-wear Dress and order in bulk",
        imageSrc: "/images/products/gym-wear/9.webp",
        imageAlt: "Gym-wear Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 10,
        name: "Gym-wear Uniform Sample Product 10",
        detail: "Customize Your Gym-wear Dress and order in bulk",
        imageSrc: "/images/products/gym-wear/10.webp",
        imageAlt: "Gym-wear Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 11,
        name: "Gym-wear Uniform Sample Product 11",
        detail: "Customize Your Gym-wear Dress and order in bulk",
        imageSrc: "/images/products/gym-wear/11.webp",
        imageAlt: "Gym-wear Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 12,
        name: "Gym-wear Uniform Sample Product 12",
        detail: "Customize Your Gym-wear Dress and order in bulk",
        imageSrc: "/images/products/gym-wear/12.webp",
        imageAlt: "Gym-wear Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 13,
        name: "Gym-wear Uniform Sample Product 13",
        detail: "Customize Your Gym-wear Dress and order in bulk",
        imageSrc: "/images/products/gym-wear/13.webp",
        imageAlt: "Gym-wear Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 14,
        name: "Gym-wear Uniform Sample Product 14",
        detail: "Customize Your Gym-wear Dress and order in bulk",
        imageSrc: "/images/products/gym-wear/14.webp",
        imageAlt: "Gym-wear Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 15,
        name: "Gym-wear Uniform Sample Product 15",
        detail: "Customize Your Gym-wear Dress and order in bulk",
        imageSrc: "/images/products/gym-wear/15.webp",
        imageAlt: "Gym-wear Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 16,
        name: "Gym-wear Uniform Sample Product 16",
        detail: "Customize Your Gym-wear Dress and order in bulk",
        imageSrc: "/images/products/gym-wear/16.webp",
        imageAlt: "Gym-wear Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 17,
        name: "Gym-wear Uniform Sample Product 17",
        detail: "Customize Your Gym-wear Dress and order in bulk",
        imageSrc: "/images/products/gym-wear/17.webp",
        imageAlt: "Gym-wear Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 18,
        name: "Gym-wear Uniform Sample Product 18",
        detail: "Customize Your Gym-wear Dress and order in bulk",
        imageSrc: "/images/products/gym-wear/18.webp",
        imageAlt: "Gym-wear Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 19,
        name: "Gym-wear Uniform Sample Product 19",
        detail: "Customize Your Gym-wear Dress and order in bulk",
        imageSrc: "/images/products/gym-wear/19.webp",
        imageAlt: "Gym-wear Uniform",
        features: "High Quality Wear",
  ...
  return (
    <>
      <Head>
        ...
        <title>Manufacturers of High-Quality Gym-wear Uniforms | Athlotic Sports</title>
        <meta
          name="title"
          content="Manufacturers of High-Quality Gym-wear Uniforms | Athlotic Sports"
        />
        <meta
          name="description"
          content="Leading manufacturers of top-tier gym-wear uniforms for athletes. Explore our premium athletic sports apparel collection today."
        />
        ...
        <link rel="canonical" href="https://athlotic.com/gym-wear" />
        <link rel="preconnect" href="//www.google-analytics.com" as="script" />
        <meta name="google" content="notranslate" />
      </Head>

      <MainHeader pageHeading="Custom Gym-wear Sports Uniform Supplier" />
