...
export default function productDetailfitting() {
  let [categories] = useState({
    MARTIALART: [
      {
        id: 1,
        name: "Martial-art Uniform Sample Product 1",
        detail: "Customize Your \Martial-art Dress and order in bulk",
        imageSrc: "/images/products/martial-art/1.webp",
        imageAlt: "\Martial-art Uniform",
        features: "High Quality Wear",

      },
      {
        id: 2,
        name: "Martial-art Uniform Sample Product 2",
        detail: "Customize Your \Martial-art Dress and order in bulk",
        imageSrc: "/images/products/martial-art/2.webp",
        imageAlt: "\Martial-art Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 3,
        name: "Martial-art Uniform Sample Product 3",
        detail: "Customize Your \Martial-art Dress and order in bulk",
        imageSrc: "/images/products/martial-art/3.webp",
        imageAlt: "\Martial-art Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 4,
        name: "Martial-art Uniform Sample Product 4",
        detail: "Customize Your \Martial-art Dress and order in bulk",
        imageSrc: "/images/products/martial-art/4.webp",
        imageAlt: "\Martial-art Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 5,
        name: "Martial-art Uniform Sample Product 5",
        detail: "Customize Your \Martial-art Dress and order in bulk",
        imageSrc: "/images/products/martial-art/5.webp",
        imageAlt: "\Martial-art Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 6,
        name: "Martial-art Uniform Sample Product 6",
        detail: "Customize Your \Martial-art Dress and order in bulk",
        imageSrc: "/images/products/martial-art/6.webp",
        imageAlt: "\Martial-art Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 7,
        name: "Martial-art Uniform Sample Product 7",
        detail: "Customize Your \Martial-art Dress and order in bulk",
        imageSrc: "/images/products/martial-art/7.webp",
        imageAlt: "\Martial-art Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 8,
        name: "Martial-art Uniform Sample Product 8",
        detail: "Customize Your \Martial-art Dress and order in bulk",
        imageSrc: "/images/products/martial-art/8.webp",
        imageAlt: "\Martial-art Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 9,
        name: "Martial-art Uniform Sample Product 9",
        detail: "Customize Your \Martial-art Dress and order in bulk",
        imageSrc: "/images/products/martial-art/9.webp",
        imageAlt: "\Martial-art Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 10,
        name: "Martial-art Uniform Sample Product 10",
        detail: "Customize Your \Martial-art Dress and order in bulk",
        imageSrc: "/images/products/martial-art/10.webp",
        imageAlt: "\Martial-art Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 11,
        name: "Martial-art Uniform Sample Product 11",
        detail: "Customize Your \Martial-art Dress and order in bulk",
        imageSrc: "/images/products/martial-art/11.webp",
        imageAlt: "\Martial-art Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 12,
        name: "Martial-art Uniform Sample Product 12",
        detail: "Customize Your \Martial-art Dress and order in bulk",
        imageSrc: "/images/products/martial-art/12.webp",
        imageAlt: "Martial-art Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 13,
        name: "Martial-art Uniform Sample Product 13",
        detail: "Customize Your Martial-art Dress and order in bulk",
        imageSrc: "/images/products/martial-art/13.webp",
        imageAlt: "Martial-art Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 14,
        name: "Martial-art Uniform Sample Product 14",
        detail: "Customize Your Martial-art Dress and order in bulk",
        imageSrc: "/images/products/martial-art/14.webp",
        imageAlt: "Martial-art Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 15,
        name: "Martial-art Uniform Sample Product 15",
        detail: "Customize Your Martial-art Dress and order in bulk",
        imageSrc: "/images/products/martial-art/15.webp",
        imageAlt: "Martial-art Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 16,
        name: "Martial-art Uniform Sample Product 16",
        detail: "Customize Your Martial-art Dress and order in bulk",
        imageSrc: "/images/products/martial-art/16.webp",
        imageAlt: "Martial-art Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 17,
        name: "Martial-art Uniform Sample Product 17",
        detail: "Customize Your Martial-art Dress and order in bulk",
        imageSrc: "/images/products/martial-art/17.webp",
        imageAlt: "Martial-art Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 18,
        name: "Martial-art Uniform Sample Product 18",
        detail: "Customize Your Martial-art Dress and order in bulk",
        imageSrc: "/images/products/martial-art/18.webp",
        imageAlt: "Martial-art Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 19,
        name: "Martial-art Uniform Sample Product 19",
        detail: "Customize Your Martial-art Dress and order in bulk",
        imageSrc: "/images/products/martial-art/19.webp",
        imageAlt: "Martial-art Uniform",
        features: "High Quality Wear",
  ...
  return (
    <>
      <Head>
        ...
        <title>Manufacturers of High-Quality Martial-art Uniforms | Athlotic Sports</title>
        <meta
          name="title"
          content="Manufacturers of High-Quality Martial-art Uniforms | Athlotic Sports"
        />
        <meta
          name="description"
          content="Leading manufacturers of top-tier martial-art uniforms for athletes. Explore our premium athletic sports apparel collection today."
        />
      ...
      <MainHeader pageHeading="Custom Martial-art Sports Uniform Supplier" />
