...
export default function productDetailfitting() {
  let [categories] = useState({
    WINTERCAPS: [
      {
        id: 1,
        name: "Winter-caps Uniform Sample Product 1",
        detail: "Customize Your \Winter-caps Dress and order in bulk",
        imageSrc: "/images/products/winter-caps/1.webp",
        imageAlt: "\Winter-caps Uniform",
        features: "High Quality Wear",

      },
      {
        id: 2,
        name: "Winter-caps Uniform Sample Product 2",
        detail: "Customize Your \Winter-caps Dress and order in bulk",
        imageSrc: "/images/products/winter-caps/2.webp",
        imageAlt: "\Winter-caps Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 3,
        name: "Winter-caps Uniform Sample Product 3",
        detail: "Customize Your \Winter-caps Dress and order in bulk",
        imageSrc: "/images/products/winter-caps/3.webp",
        imageAlt: "\Winter-caps Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 4,
        name: "Winter-caps Uniform Sample Product 4",
        detail: "Customize Your \Winter-caps Dress and order in bulk",
        imageSrc: "/images/products/winter-caps/4.webp",
        imageAlt: "\Winter-caps Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 5,
        name: "Winter-caps Uniform Sample Product 5",
        detail: "Customize Your \Winter-caps Dress and order in bulk",
        imageSrc: "/images/products/winter-caps/5.webp",
        imageAlt: "\Winter-caps Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 6,
        name: "Winter-caps Uniform Sample Product 6",
        detail: "Customize Your \Winter-caps Dress and order in bulk",
        imageSrc: "/images/products/winter-caps/6.webp",
        imageAlt: "\Winter-caps Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 7,
        name: "Winter-caps Uniform Sample Product 7",
        detail: "Customize Your \Winter-caps Dress and order in bulk",
        imageSrc: "/images/products/winter-caps/7.webp",
        imageAlt: "\Winter-caps Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 8,
        name: "Winter-caps Uniform Sample Product 8",
        detail: "Customize Your \Winter-caps Dress and order in bulk",
        imageSrc: "/images/products/winter-caps/8.webp",
        imageAlt: "\Winter-caps Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 9,
        name: "Winter-caps Uniform Sample Product 9",
        detail: "Customize Your \Winter-caps Dress and order in bulk",
        imageSrc: "/images/products/winter-caps/9.webp",
        imageAlt: "\Winter-caps Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 10,
        name: "Winter-caps Uniform Sample Product 10",
        detail: "Customize Your \Winter-caps Dress and order in bulk",
        imageSrc: "/images/products/winter-caps/10.webp",
        imageAlt: "\Winter-caps Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 11,
        name: "Winter-caps Uniform Sample Product 11",
        detail: "Customize Your \Winter-caps Dress and order in bulk",
        imageSrc: "/images/products/winter-caps/11.webp",
        imageAlt: "\Winter-caps Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 12,
        name: "Winter-caps Uniform Sample Product 12",
        detail: "Customize Your \Winter-caps Dress and order in bulk",
        imageSrc: "/images/products/winter-caps/12.webp",
        imageAlt: "Winter-caps Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 13,
        name: "Winter-caps Uniform Sample Product 13",
        detail: "Customize Your Winter-caps Dress and order in bulk",
        imageSrc: "/images/products/winter-caps/13.webp",
        imageAlt: "Winter-caps Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 14,
        name: "Winter-caps Uniform Sample Product 14",
        detail: "Customize Your Winter-caps Dress and order in bulk",
        imageSrc: "/images/products/winter-caps/14.webp",
        imageAlt: "Winter-caps Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 15,
        name: "Winter-caps Uniform Sample Product 15",
        detail: "Customize Your Winter-caps Dress and order in bulk",
        imageSrc: "/images/products/winter-caps/15.webp",
        imageAlt: "Winter-caps Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 16,
        name: "Winter-caps Uniform Sample Product 16",
        detail: "Customize Your Winter-caps Dress and order in bulk",
        imageSrc: "/images/products/winter-caps/16.webp",
        imageAlt: "Winter-caps Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 17,
        name: "Winter-caps Uniform Sample Product 17",
        detail: "Customize Your Winter-caps Dress and order in bulk",
        imageSrc: "/images/products/winter-caps/17.webp",
        imageAlt: "Winter-caps Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 18,
        name: "Winter-caps Uniform Sample Product 18",
        detail: "Customize Your Winter-caps Dress and order in bulk",
        imageSrc: "/images/products/winter-caps/18.webp",
        imageAlt: "Winter-caps Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 19,
        name: "Winter-caps Uniform Sample Product 19",
        detail: "Customize Your Winter-caps Dress and order in bulk",
        imageSrc: "/images/products/winter-caps/19.webp",
        imageAlt: "Winter-caps Uniform",
        features: "High Quality Wear",
  ...
  return (
    <>
      <Head>
        ...
        <title>Manufacturers of High-Quality Winter-caps Uniforms | Athlotic Sports</title>
        <meta
          name="title"
          content="Manufacturers of High-Quality Winter-caps Uniforms | Athlotic Sports"
        />
        <meta
          name="description"
          content="Leading manufacturers of top-tier winter-caps uniforms for athletes. Explore our premium athletic sports apparel collection today."
        />
      ...
      <MainHeader pageHeading="Custom Winter-caps Sports Uniform Supplier" />
