...
export default function productDetailfitting() {
  let [categories] = useState({
    SOCKS: [
      {
        id: 1,
        name: "Socks Uniform Sample Product 1",
        detail: "Customize Your \Socks Dress and order in bulk",
        imageSrc: "/images/products/socks/1.webp",
        imageAlt: "\Socks Uniform",
        features: "High Quality Wear",

      },
      {
        id: 2,
        name: "Socks Uniform Sample Product 2",
        detail: "Customize Your \Socks Dress and order in bulk",
        imageSrc: "/images/products/socks/2.webp",
        imageAlt: "\Socks Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 3,
        name: "Socks Uniform Sample Product 3",
        detail: "Customize Your \Socks Dress and order in bulk",
        imageSrc: "/images/products/socks/3.webp",
        imageAlt: "\Socks Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 4,
        name: "Socks Uniform Sample Product 4",
        detail: "Customize Your \Socks Dress and order in bulk",
        imageSrc: "/images/products/socks/4.webp",
        imageAlt: "\Socks Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 5,
        name: "Socks Uniform Sample Product 5",
        detail: "Customize Your \Socks Dress and order in bulk",
        imageSrc: "/images/products/socks/5.webp",
        imageAlt: "\Socks Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 6,
        name: "Socks Uniform Sample Product 6",
        detail: "Customize Your \Socks Dress and order in bulk",
        imageSrc: "/images/products/socks/6.webp",
        imageAlt: "\Socks Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 7,
        name: "Socks Uniform Sample Product 7",
        detail: "Customize Your \Socks Dress and order in bulk",
        imageSrc: "/images/products/socks/7.webp",
        imageAlt: "\Socks Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 8,
        name: "Socks Uniform Sample Product 8",
        detail: "Customize Your \Socks Dress and order in bulk",
        imageSrc: "/images/products/socks/8.webp",
        imageAlt: "\Socks Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 9,
        name: "Socks Uniform Sample Product 9",
        detail: "Customize Your \Socks Dress and order in bulk",
        imageSrc: "/images/products/socks/9.webp",
        imageAlt: "\Socks Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 10,
        name: "Socks Uniform Sample Product 10",
        detail: "Customize Your \Socks Dress and order in bulk",
        imageSrc: "/images/products/socks/10.webp",
        imageAlt: "\Socks Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 11,
        name: "Socks Uniform Sample Product 11",
        detail: "Customize Your \Socks Dress and order in bulk",
        imageSrc: "/images/products/socks/11.webp",
        imageAlt: "\Socks Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 12,
        name: "Socks Uniform Sample Product 12",
        detail: "Customize Your \Socks Dress and order in bulk",
        imageSrc: "/images/products/socks/12.webp",
        imageAlt: "Socks Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 13,
        name: "Socks Uniform Sample Product 13",
        detail: "Customize Your Socks Dress and order in bulk",
        imageSrc: "/images/products/socks/13.webp",
        imageAlt: "Socks Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 14,
        name: "Socks Uniform Sample Product 14",
        detail: "Customize Your Socks Dress and order in bulk",
        imageSrc: "/images/products/socks/14.webp",
        imageAlt: "Socks Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 15,
        name: "Socks Uniform Sample Product 15",
        detail: "Customize Your Socks Dress and order in bulk",
        imageSrc: "/images/products/socks/15.webp",
        imageAlt: "Socks Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 16,
        name: "Socks Uniform Sample Product 16",
        detail: "Customize Your Socks Dress and order in bulk",
        imageSrc: "/images/products/socks/16.webp",
        imageAlt: "Socks Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 17,
        name: "Socks Uniform Sample Product 17",
        detail: "Customize Your Socks Dress and order in bulk",
        imageSrc: "/images/products/socks/17.webp",
        imageAlt: "Socks Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 18,
        name: "Socks Uniform Sample Product 18",
        detail: "Customize Your Socks Dress and order in bulk",
        imageSrc: "/images/products/socks/18.webp",
        imageAlt: "Socks Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 19,
        name: "Socks Uniform Sample Product 19",
        detail: "Customize Your Socks Dress and order in bulk",
        imageSrc: "/images/products/socks/19.webp",
        imageAlt: "Socks Uniform",
        features: "High Quality Wear",
  ...
  return (
    <>
      <Head>
        ...
        <title>Manufacturers of High-Quality Socks Uniforms | Athlotic Sports</title>
        <meta
          name="title"
          content="Manufacturers of High-Quality Socks Uniforms | Athlotic Sports"
        />
        <meta
          name="description"
          content="Leading manufacturers of top-tier socks uniforms for athletes. Explore our premium athletic sports apparel collection today."
        />
      ...
      <MainHeader pageHeading="Custom Socks Sports Uniform Supplier" />
