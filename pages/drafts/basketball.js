...
export default function productDetailfitting() {
  let [categories] = useState({
    BASKETBALL: [
      {
        id: 1,
        name: "Basketball Uniform Sample Product 1",
        detail: "Customize Your \Basketball Dress and order in bulk",
        imageSrc: "/images/products/basketball/1.webp",
        imageAlt: "\Basketball Uniform",
        features: "High Quality Wear",

      },
      {
        id: 2,
        name: "Basketball Uniform Sample Product 2",
        detail: "Customize Your \Basketball Dress and order in bulk",
        imageSrc: "/images/products/basketball/2.webp",
        imageAlt: "\Basketball Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 3,
        name: "Basketball Uniform Sample Product 3",
        detail: "Customize Your \Basketball Dress and order in bulk",
        imageSrc: "/images/products/basketball/3.webp",
        imageAlt: "\Basketball Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 4,
        name: "Basketball Uniform Sample Product 4",
        detail: "Customize Your \Basketball Dress and order in bulk",
        imageSrc: "/images/products/basketball/4.webp",
        imageAlt: "\Basketball Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 5,
        name: "Basketball Uniform Sample Product 5",
        detail: "Customize Your \Basketball Dress and order in bulk",
        imageSrc: "/images/products/basketball/5.webp",
        imageAlt: "\Basketball Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 6,
        name: "Basketball Uniform Sample Product 6",
        detail: "Customize Your \Basketball Dress and order in bulk",
        imageSrc: "/images/products/basketball/6.webp",
        imageAlt: "\Basketball Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 7,
        name: "Basketball Uniform Sample Product 7",
        detail: "Customize Your \Basketball Dress and order in bulk",
        imageSrc: "/images/products/basketball/7.webp",
        imageAlt: "\Basketball Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 8,
        name: "Basketball Uniform Sample Product 8",
        detail: "Customize Your \Basketball Dress and order in bulk",
        imageSrc: "/images/products/basketball/8.webp",
        imageAlt: "\Basketball Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 9,
        name: "Basketball Uniform Sample Product 9",
        detail: "Customize Your \Basketball Dress and order in bulk",
        imageSrc: "/images/products/basketball/9.webp",
        imageAlt: "\Basketball Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 10,
        name: "Basketball Uniform Sample Product 10",
        detail: "Customize Your \Basketball Dress and order in bulk",
        imageSrc: "/images/products/basketball/10.webp",
        imageAlt: "\Basketball Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 11,
        name: "Basketball Uniform Sample Product 11",
        detail: "Customize Your \Basketball Dress and order in bulk",
        imageSrc: "/images/products/basketball/11.webp",
        imageAlt: "\Basketball Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 12,
        name: "Basketball Uniform Sample Product 12",
        detail: "Customize Your \Basketball Dress and order in bulk",
        imageSrc: "/images/products/basketball/12.webp",
        imageAlt: "Basketball Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 13,
        name: "Basketball Uniform Sample Product 13",
        detail: "Customize Your Basketball Dress and order in bulk",
        imageSrc: "/images/products/basketball/13.webp",
        imageAlt: "Basketball Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 14,
        name: "Basketball Uniform Sample Product 14",
        detail: "Customize Your Basketball Dress and order in bulk",
        imageSrc: "/images/products/basketball/14.webp",
        imageAlt: "Basketball Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 15,
        name: "Basketball Uniform Sample Product 15",
        detail: "Customize Your Basketball Dress and order in bulk",
        imageSrc: "/images/products/basketball/15.webp",
        imageAlt: "Basketball Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 16,
        name: "Basketball Uniform Sample Product 16",
        detail: "Customize Your Basketball Dress and order in bulk",
        imageSrc: "/images/products/basketball/16.webp",
        imageAlt: "Basketball Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 17,
        name: "Basketball Uniform Sample Product 17",
        detail: "Customize Your Basketball Dress and order in bulk",
        imageSrc: "/images/products/basketball/17.webp",
        imageAlt: "Basketball Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 18,
        name: "Basketball Uniform Sample Product 18",
        detail: "Customize Your Basketball Dress and order in bulk",
        imageSrc: "/images/products/basketball/18.webp",
        imageAlt: "Basketball Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 19,
        name: "Basketball Uniform Sample Product 19",
        detail: "Customize Your Basketball Dress and order in bulk",
        imageSrc: "/images/products/basketball/19.webp",
        imageAlt: "Basketball Uniform",
        features: "High Quality Wear",
  ...
  return (
    <>
      <Head>
        ...
        <title>Manufacturers of High-Quality Basketball Uniforms | Athlotic Sports</title>
        <meta
          name="title"
          content="Manufacturers of High-Quality Basketball Uniforms | Athlotic Sports"
        />
        <meta
          name="description"
          content="Leading manufacturers of top-tier basketball uniforms for athletes. Explore our premium athletic sports apparel collection today."
        />
      ...
      <MainHeader pageHeading="Custom Basketball Sports Uniform Supplier" />
