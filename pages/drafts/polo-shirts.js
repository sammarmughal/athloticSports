...
export default function productDetailfitting() {
  let [categories] = useState({
    POLOSHIRTS: [
      {
        id: 1,
        name: "Polo-shirts Uniform Sample Product 1",
        detail: "Customize Your \Polo-shirts Dress and order in bulk",
        imageSrc: "/images/products/Polo-shirts/1.webp",
        imageAlt: "\Polo-shirts Uniform",
        features: "High Quality Wear",

      },
      {
        id: 2,
        name: "Polo-shirts Uniform Sample Product 2",
        detail: "Customize Your \Polo-shirts Dress and order in bulk",
        imageSrc: "/images/products/Polo-shirts/2.webp",
        imageAlt: "\Polo-shirts Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 3,
        name: "Polo-shirts Uniform Sample Product 3",
        detail: "Customize Your \Polo-shirts Dress and order in bulk",
        imageSrc: "/images/products/Polo-shirts/3.webp",
        imageAlt: "\Polo-shirts Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 4,
        name: "Polo-shirts Uniform Sample Product 4",
        detail: "Customize Your \Polo-shirts Dress and order in bulk",
        imageSrc: "/images/products/Polo-shirts/4.webp",
        imageAlt: "\Polo-shirts Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 5,
        name: "Polo-shirts Uniform Sample Product 5",
        detail: "Customize Your \Polo-shirts Dress and order in bulk",
        imageSrc: "/images/products/Polo-shirts/5.webp",
        imageAlt: "\Polo-shirts Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 6,
        name: "Polo-shirts Uniform Sample Product 6",
        detail: "Customize Your \Polo-shirts Dress and order in bulk",
        imageSrc: "/images/products/Polo-shirts/6.webp",
        imageAlt: "\Polo-shirts Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 7,
        name: "Polo-shirts Uniform Sample Product 7",
        detail: "Customize Your \Polo-shirts Dress and order in bulk",
        imageSrc: "/images/products/Polo-shirts/7.webp",
        imageAlt: "\Polo-shirts Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 8,
        name: "Polo-shirts Uniform Sample Product 8",
        detail: "Customize Your \Polo-shirts Dress and order in bulk",
        imageSrc: "/images/products/Polo-shirts/8.webp",
        imageAlt: "\Polo-shirts Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 9,
        name: "Polo-shirts Uniform Sample Product 9",
        detail: "Customize Your \Polo-shirts Dress and order in bulk",
        imageSrc: "/images/products/Polo-shirts/9.webp",
        imageAlt: "\Polo-shirts Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 10,
        name: "Polo-shirts Uniform Sample Product 10",
        detail: "Customize Your \Polo-shirts Dress and order in bulk",
        imageSrc: "/images/products/Polo-shirts/10.webp",
        imageAlt: "\Polo-shirts Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 11,
        name: "Polo-shirts Uniform Sample Product 11",
        detail: "Customize Your \Polo-shirts Dress and order in bulk",
        imageSrc: "/images/products/Polo-shirts/11.webp",
        imageAlt: "\Polo-shirts Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 12,
        name: "Polo-shirts Uniform Sample Product 12",
        detail: "Customize Your \Polo-shirts Dress and order in bulk",
        imageSrc: "/images/products/Polo-shirts/12.webp",
        imageAlt: "Polo-shirts Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 13,
        name: "Polo-shirts Uniform Sample Product 13",
        detail: "Customize Your Polo-shirts Dress and order in bulk",
        imageSrc: "/images/products/Polo-shirts/13.webp",
        imageAlt: "Polo-shirts Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 14,
        name: "Polo-shirts Uniform Sample Product 14",
        detail: "Customize Your Polo-shirts Dress and order in bulk",
        imageSrc: "/images/products/Polo-shirts/14.webp",
        imageAlt: "Polo-shirts Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 15,
        name: "Polo-shirts Uniform Sample Product 15",
        detail: "Customize Your Polo-shirts Dress and order in bulk",
        imageSrc: "/images/products/Polo-shirts/15.webp",
        imageAlt: "Polo-shirts Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 16,
        name: "Polo-shirts Uniform Sample Product 16",
        detail: "Customize Your Polo-shirts Dress and order in bulk",
        imageSrc: "/images/products/Polo-shirts/16.webp",
        imageAlt: "Polo-shirts Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 17,
        name: "Polo-shirts Uniform Sample Product 17",
        detail: "Customize Your Polo-shirts Dress and order in bulk",
        imageSrc: "/images/products/Polo-shirts/17.webp",
        imageAlt: "Polo-shirts Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 18,
        name: "Polo-shirts Uniform Sample Product 18",
        detail: "Customize Your Polo-shirts Dress and order in bulk",
        imageSrc: "/images/products/Polo-shirts/18.webp",
        imageAlt: "Polo-shirts Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 19,
        name: "Polo-shirts Uniform Sample Product 19",
        detail: "Customize Your Polo-shirts Dress and order in bulk",
        imageSrc: "/images/products/Polo-shirts/19.webp",
        imageAlt: "Polo-shirts Uniform",
        features: "High Quality Wear",
  ...
  return (
    <>
      <Head>
        ...
        <title>Manufacturers of High-Quality Polo-shirts Uniforms | Athlotic Sports</title>
        <meta
          name="title"
          content="Manufacturers of High-Quality Polo-shirts Uniforms | Athlotic Sports"
        />
        <meta
          name="description"
          content="Leading manufacturers of top-tier polo-shirts uniforms for athletes. Explore our premium athletic sports apparel collection today."
        />
      ...
      <MainHeader pageHeading="Custom Polo-shirts Sports Uniform Supplier" />
