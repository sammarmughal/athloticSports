...
export default function productDetailfitting() {
  let [categories] = useState({
    SOCCERS: [
      {
        id: 1,
        name: "Soccer Uniform Sample Product 1",
        detail: "Customize Your Soccer Dress and order in bulk",
        imageSrc: "/images/products/soccer/1.webp",
        imageAlt: "Soccer Uniform",
        features: "High Quality Wear",

      },
      {
        id: 2,
        name: "Soccer Uniform Sample Product 2",
        detail: "Customize Your Soccer Dress and order in bulk",
        imageSrc: "/images/products/soccer/2.webp",
        imageAlt: "Soccer Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 3,
        name: "Soccer Uniform Sample Product 3",
        detail: "Customize Your Soccer Dress and order in bulk",
        imageSrc: "/images/products/soccer/3.webp",
        imageAlt: "Soccer Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 4,
        name: "Soccer Uniform Sample Product 4",
        detail: "Customize Your Soccer Dress and order in bulk",
        imageSrc: "/images/products/soccer/4.webp",
        imageAlt: "Soccer Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 5,
        name: "Soccer Uniform Sample Product 5",
        detail: "Customize Your Soccer Dress and order in bulk",
        imageSrc: "/images/products/soccer/5.webp",
        imageAlt: "Soccer Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 6,
        name: "Soccer Uniform Sample Product 6",
        detail: "Customize Your Soccer Dress and order in bulk",
        imageSrc: "/images/products/soccer/6.webp",
        imageAlt: "Soccer Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 7,
        name: "Soccer Uniform Sample Product 7",
        detail: "Customize Your Soccer Dress and order in bulk",
        imageSrc: "/images/products/soccer/7.webp",
        imageAlt: "Soccer Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 8,
        name: "Soccer Uniform Sample Product 8",
        detail: "Customize Your Soccer Dress and order in bulk",
        imageSrc: "/images/products/soccer/8.webp",
        imageAlt: "Soccer Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 9,
        name: "Soccer Uniform Sample Product 9",
        detail: "Customize Your Soccer Dress and order in bulk",
        imageSrc: "/images/products/soccer/9.webp",
        imageAlt: "Soccer Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 10,
        name: "Soccer Uniform Sample Product 10",
        detail: "Customize Your Soccer Dress and order in bulk",
        imageSrc: "/images/products/soccer/10.webp",
        imageAlt: "Soccer Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 11,
        name: "Soccer Uniform Sample Product 11",
        detail: "Customize Your Soccer Dress and order in bulk",
        imageSrc: "/images/products/soccer/11.webp",
        imageAlt: "Soccer Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 12,
        name: "Soccer Uniform Sample Product 12",
        detail: "Customize Your Soccer Dress and order in bulk",
        imageSrc: "/images/products/soccer/12.webp",
        imageAlt: "Soccer Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 13,
        name: "Soccer Uniform Sample Product 13",
        detail: "Customize Your Soccer Dress and order in bulk",
        imageSrc: "/images/products/soccer/13.webp",
        imageAlt: "Soccer Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 14,
        name: "Soccer Uniform Sample Product 14",
        detail: "Customize Your Soccer Dress and order in bulk",
        imageSrc: "/images/products/soccer/14.webp",
        imageAlt: "Soccer Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 15,
        name: "Soccer Uniform Sample Product 15",
        detail: "Customize Your Soccer Dress and order in bulk",
        imageSrc: "/images/products/soccer/15.webp",
        imageAlt: "Soccer Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 16,
        name: "Soccer Uniform Sample Product 16",
        detail: "Customize Your Soccer Dress and order in bulk",
        imageSrc: "/images/products/soccer/16.webp",
        imageAlt: "Soccer Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 17,
        name: "Soccer Uniform Sample Product 17",
        detail: "Customize Your Soccer Dress and order in bulk",
        imageSrc: "/images/products/soccer/17.webp",
        imageAlt: "Soccer Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 18,
        name: "Soccer Uniform Sample Product 18",
        detail: "Customize Your Soccer Dress and order in bulk",
        imageSrc: "/images/products/soccer/18.webp",
        imageAlt: "Soccer Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 19,
        name: "Soccer Uniform Sample Product 19",
        detail: "Customize Your Soccer Dress and order in bulk",
        imageSrc: "/images/products/soccer/19.webp",
        imageAlt: "Soccer Uniform",
        features: "High Quality Wear",
  ...
  return (
    <>
      <Head>
        ...
        <title>Manufacturers of High-Quality Soccer Uniforms | Athlotic Sports</title>
        <meta
          name="title"
          content="Manufacturers of High-Quality Soccer Uniforms | Athlotic Sports"
        />
        <meta
          name="description"
      ...
      <MainHeader pageHeading="Custom Soccer Sports Uniform Supplier" />
