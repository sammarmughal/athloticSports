...
export default function productDetailfitting() {
  let [categories] = useState({
    ICEHOCKEY: [
      {
        id: 1,
        name: "Ice-hockey Uniform Sample Product 1",
        detail: "Customize Your Ice-hockey Dress and order in bulk",
        imageSrc: "/images/products/ice-hockey/1.webp",
        imageAlt: "Ice-hockey Uniform",
        features: "High Quality Wear",

      },
      {
        id: 2,
        name: "Ice-hockey Uniform Sample Product 2",
        detail: "Customize Your Ice-hockey Dress and order in bulk",
        imageSrc: "/images/products/ice-hockey/2.webp",
        imageAlt: "Ice-hockey Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 3,
        name: "Ice-hockey Uniform Sample Product 3",
        detail: "Customize Your Ice-hockey Dress and order in bulk",
        imageSrc: "/images/products/ice-hockey/3.webp",
        imageAlt: "Ice-hockey Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 4,
        name: "Ice-hockey Uniform Sample Product 4",
        detail: "Customize Your Ice-hockey Dress and order in bulk",
        imageSrc: "/images/products/ice-hockey/4.webp",
        imageAlt: "Ice-hockey Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 5,
        name: "Ice-hockey Uniform Sample Product 5",
        detail: "Customize Your Ice-hockey Dress and order in bulk",
        imageSrc: "/images/products/ice-hockey/5.webp",
        imageAlt: "Ice-hockey Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 6,
        name: "Ice-hockey Uniform Sample Product 6",
        detail: "Customize Your Ice-hockey Dress and order in bulk",
        imageSrc: "/images/products/ice-hockey/6.webp",
        imageAlt: "Ice-hockey Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 7,
        name: "Ice-hockey Uniform Sample Product 7",
        detail: "Customize Your Ice-hockey Dress and order in bulk",
        imageSrc: "/images/products/ice-hockey/7.webp",
        imageAlt: "Ice-hockey Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 8,
        name: "Ice-hockey Uniform Sample Product 8",
        detail: "Customize Your Ice-hockey Dress and order in bulk",
        imageSrc: "/images/products/ice-hockey/8.webp",
        imageAlt: "Ice-hockey Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 9,
        name: "Ice-hockey Uniform Sample Product 9",
        detail: "Customize Your Ice-hockey Dress and order in bulk",
        imageSrc: "/images/products/ice-hockey/9.webp",
        imageAlt: "Ice-hockey Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 10,
        name: "Ice-hockey Uniform Sample Product 10",
        detail: "Customize Your Ice-hockey Dress and order in bulk",
        imageSrc: "/images/products/ice-hockey/10.webp",
        imageAlt: "Ice-hockey Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 11,
        name: "Ice-hockey Uniform Sample Product 11",
        detail: "Customize Your Ice-hockey Dress and order in bulk",
        imageSrc: "/images/products/ice-hockey/11.webp",
        imageAlt: "Ice-hockey Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 12,
        name: "Ice-hockey Uniform Sample Product 12",
        detail: "Customize Your Ice-hockey Dress and order in bulk",
        imageSrc: "/images/products/ice-hockey/12.webp",
        imageAlt: "Ice-hockey Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 13,
        name: "Ice-hockey Uniform Sample Product 13",
        detail: "Customize Your Ice-hockey Dress and order in bulk",
        imageSrc: "/images/products/ice-hockey/13.webp",
        imageAlt: "Ice-hockey Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 14,
        name: "Ice-hockey Uniform Sample Product 14",
        detail: "Customize Your Ice-hockey Dress and order in bulk",
        imageSrc: "/images/products/ice-hockey/14.webp",
        imageAlt: "Ice-hockey Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 15,
        name: "Ice-hockey Uniform Sample Product 15",
        detail: "Customize Your Ice-hockey Dress and order in bulk",
        imageSrc: "/images/products/ice-hockey/15.webp",
        imageAlt: "Ice-hockey Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 16,
        name: "Ice-hockey Uniform Sample Product 16",
        detail: "Customize Your Ice-hockey Dress and order in bulk",
        imageSrc: "/images/products/ice-hockey/16.webp",
        imageAlt: "Ice-hockey Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 17,
        name: "Ice-hockey Uniform Sample Product 17",
        detail: "Customize Your Ice-hockey Dress and order in bulk",
        imageSrc: "/images/products/ice-hockey/17.webp",
        imageAlt: "Ice-hockey Uniform",
        features: "High Quality Wear",
  ...
  return (
    <>
      <Head>
        ...
        <title>Manufacturers of High-Quality Ice-hockey Uniforms | Athlotic Sports</title>
        <meta
          name="title"
          content="Manufacturers of High-Quality Ice-hockey Uniforms | Athlotic Sports"
        />
        <meta
          name="description"
          content="Leading manufacturers of top-tier ice-hockey uniforms for athletes. Explore our premium athletic sports apparel collection today."
        />
        ...
        <link rel="canonical" href="https://athlotic.com/ice-hockey" />
        <link rel="preconnect" href="//www.google-analytics.com" as="script" />
        <meta name="google" content="notranslate" />
      </Head>

      <MainHeader pageHeading="Custom Ice-hockey Sports Uniform Supplier" />
