...
export default function productDetailfitting() {
  let [categories] = useState({
    SOFTSHELLJACKETS: [
      {
        id: 1,
        name: "Softshell-jackets Uniform Sample Product 1",
        detail: "Customize Your \Softshell-jackets Dress and order in bulk",
        imageSrc: "/images/products/softshell-jackets/1.webp",
        imageAlt: "\Softshell-jackets Uniform",
        features: "High Quality Wear",

      },
      {
        id: 2,
        name: "Softshell-jackets Uniform Sample Product 2",
        detail: "Customize Your \Softshell-jackets Dress and order in bulk",
        imageSrc: "/images/products/softshell-jackets/2.webp",
        imageAlt: "\Softshell-jackets Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 3,
        name: "Softshell-jackets Uniform Sample Product 3",
        detail: "Customize Your \Softshell-jackets Dress and order in bulk",
        imageSrc: "/images/products/softshell-jackets/3.webp",
        imageAlt: "\Softshell-jackets Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 4,
        name: "Softshell-jackets Uniform Sample Product 4",
        detail: "Customize Your \Softshell-jackets Dress and order in bulk",
        imageSrc: "/images/products/softshell-jackets/4.webp",
        imageAlt: "\Softshell-jackets Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 5,
        name: "Softshell-jackets Uniform Sample Product 5",
        detail: "Customize Your \Softshell-jackets Dress and order in bulk",
        imageSrc: "/images/products/softshell-jackets/5.webp",
        imageAlt: "\Softshell-jackets Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 6,
        name: "Softshell-jackets Uniform Sample Product 6",
        detail: "Customize Your \Softshell-jackets Dress and order in bulk",
        imageSrc: "/images/products/softshell-jackets/6.webp",
        imageAlt: "\Softshell-jackets Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 7,
        name: "Softshell-jackets Uniform Sample Product 7",
        detail: "Customize Your \Softshell-jackets Dress and order in bulk",
        imageSrc: "/images/products/softshell-jackets/7.webp",
        imageAlt: "\Softshell-jackets Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 8,
        name: "Softshell-jackets Uniform Sample Product 8",
        detail: "Customize Your \Softshell-jackets Dress and order in bulk",
        imageSrc: "/images/products/softshell-jackets/8.webp",
        imageAlt: "\Softshell-jackets Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 9,
        name: "Softshell-jackets Uniform Sample Product 9",
        detail: "Customize Your \Softshell-jackets Dress and order in bulk",
        imageSrc: "/images/products/softshell-jackets/9.webp",
        imageAlt: "\Softshell-jackets Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 10,
        name: "Softshell-jackets Uniform Sample Product 10",
        detail: "Customize Your \Softshell-jackets Dress and order in bulk",
        imageSrc: "/images/products/softshell-jackets/10.webp",
        imageAlt: "\Softshell-jackets Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 11,
        name: "Softshell-jackets Uniform Sample Product 11",
        detail: "Customize Your \Softshell-jackets Dress and order in bulk",
        imageSrc: "/images/products/softshell-jackets/11.webp",
        imageAlt: "\Softshell-jackets Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 12,
        name: "Softshell-jackets Uniform Sample Product 12",
        detail: "Customize Your \Softshell-jackets Dress and order in bulk",
        imageSrc: "/images/products/softshell-jackets/12.webp",
        imageAlt: "Softshell-jackets Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 13,
        name: "Softshell-jackets Uniform Sample Product 13",
        detail: "Customize Your Softshell-jackets Dress and order in bulk",
        imageSrc: "/images/products/softshell-jackets/13.webp",
        imageAlt: "Softshell-jackets Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 14,
        name: "Softshell-jackets Uniform Sample Product 14",
        detail: "Customize Your Softshell-jackets Dress and order in bulk",
        imageSrc: "/images/products/softshell-jackets/14.webp",
        imageAlt: "Softshell-jackets Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 15,
        name: "Softshell-jackets Uniform Sample Product 15",
        detail: "Customize Your Softshell-jackets Dress and order in bulk",
        imageSrc: "/images/products/softshell-jackets/15.webp",
        imageAlt: "Softshell-jackets Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 16,
        name: "Softshell-jackets Uniform Sample Product 16",
        detail: "Customize Your Softshell-jackets Dress and order in bulk",
        imageSrc: "/images/products/softshell-jackets/16.webp",
        imageAlt: "Softshell-jackets Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 17,
        name: "Softshell-jackets Uniform Sample Product 17",
        detail: "Customize Your Softshell-jackets Dress and order in bulk",
        imageSrc: "/images/products/softshell-jackets/17.webp",
        imageAlt: "Softshell-jackets Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 18,
        name: "Softshell-jackets Uniform Sample Product 18",
        detail: "Customize Your Softshell-jackets Dress and order in bulk",
        imageSrc: "/images/products/softshell-jackets/18.webp",
        imageAlt: "Softshell-jackets Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 19,
        name: "Softshell-jackets Uniform Sample Product 19",
        detail: "Customize Your Softshell-jackets Dress and order in bulk",
        imageSrc: "/images/products/softshell-jackets/19.webp",
        imageAlt: "Softshell-jackets Uniform",
        features: "High Quality Wear",
  ...
  return (
    <>
      <Head>
        ...
        <title>Manufacturers of High-Quality Softshell-jackets Uniforms | Athlotic Sports</title>
        <meta
          name="title"
          content="Manufacturers of High-Quality Softshell-jackets Uniforms | Athlotic Sports"
        />
        <meta
          name="description"
          content="Leading manufacturers of top-tier softshell-jackets uniforms for athletes. Explore our premium athletic sports apparel collection today."
        />
      ...
      <MainHeader pageHeading="Custom Softshell-jackets Sports Uniform Supplier" />
