...
export default function productDetailfitting() {
  let [categories] = useState({
    MEDICAL: [
      {
        id: 1,
        name: "Medical Uniform Sample Product 1",
        detail: "Customize Your \Medical Dress and order in bulk",
        imageSrc: "/images/products/medical/1.webp",
        imageAlt: "\Medical Uniform",
        features: "High Quality Wear",

      },
      {
        id: 2,
        name: "Medical Uniform Sample Product 2",
        detail: "Customize Your \Medical Dress and order in bulk",
        imageSrc: "/images/products/medical/2.webp",
        imageAlt: "\Medical Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 3,
        name: "Medical Uniform Sample Product 3",
        detail: "Customize Your \Medical Dress and order in bulk",
        imageSrc: "/images/products/medical/3.webp",
        imageAlt: "\Medical Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 4,
        name: "Medical Uniform Sample Product 4",
        detail: "Customize Your \Medical Dress and order in bulk",
        imageSrc: "/images/products/medical/4.webp",
        imageAlt: "\Medical Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 5,
        name: "Medical Uniform Sample Product 5",
        detail: "Customize Your \Medical Dress and order in bulk",
        imageSrc: "/images/products/medical/5.webp",
        imageAlt: "\Medical Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 6,
        name: "Medical Uniform Sample Product 6",
        detail: "Customize Your \Medical Dress and order in bulk",
        imageSrc: "/images/products/medical/6.webp",
        imageAlt: "\Medical Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 7,
        name: "Medical Uniform Sample Product 7",
        detail: "Customize Your \Medical Dress and order in bulk",
        imageSrc: "/images/products/medical/7.webp",
        imageAlt: "\Medical Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 8,
        name: "Medical Uniform Sample Product 8",
        detail: "Customize Your \Medical Dress and order in bulk",
        imageSrc: "/images/products/medical/8.webp",
        imageAlt: "\Medical Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 9,
        name: "Medical Uniform Sample Product 9",
        detail: "Customize Your \Medical Dress and order in bulk",
        imageSrc: "/images/products/medical/9.webp",
        imageAlt: "\Medical Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 10,
        name: "Medical Uniform Sample Product 10",
        detail: "Customize Your \Medical Dress and order in bulk",
        imageSrc: "/images/products/medical/10.webp",
        imageAlt: "\Medical Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 11,
        name: "Medical Uniform Sample Product 11",
        detail: "Customize Your \Medical Dress and order in bulk",
        imageSrc: "/images/products/medical/11.webp",
        imageAlt: "\Medical Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 12,
        name: "Medical Uniform Sample Product 12",
        detail: "Customize Your \Medical Dress and order in bulk",
        imageSrc: "/images/products/medical/12.webp",
        imageAlt: "Medical Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 13,
        name: "Medical Uniform Sample Product 13",
        detail: "Customize Your Medical Dress and order in bulk",
        imageSrc: "/images/products/medical/13.webp",
        imageAlt: "Medical Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 14,
        name: "Medical Uniform Sample Product 14",
        detail: "Customize Your Medical Dress and order in bulk",
        imageSrc: "/images/products/medical/14.webp",
        imageAlt: "Medical Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 15,
        name: "Medical Uniform Sample Product 15",
        detail: "Customize Your Medical Dress and order in bulk",
        imageSrc: "/images/products/medical/15.webp",
        imageAlt: "Medical Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 16,
        name: "Medical Uniform Sample Product 16",
        detail: "Customize Your Medical Dress and order in bulk",
        imageSrc: "/images/products/medical/16.webp",
        imageAlt: "Medical Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 17,
        name: "Medical Uniform Sample Product 17",
        detail: "Customize Your Medical Dress and order in bulk",
        imageSrc: "/images/products/medical/17.webp",
        imageAlt: "Medical Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 18,
        name: "Medical Uniform Sample Product 18",
        detail: "Customize Your Medical Dress and order in bulk",
        imageSrc: "/images/products/medical/18.webp",
        imageAlt: "Medical Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 19,
        name: "Medical Uniform Sample Product 19",
        detail: "Customize Your Medical Dress and order in bulk",
        imageSrc: "/images/products/medical/19.webp",
        imageAlt: "Medical Uniform",
        features: "High Quality Wear",
  ...
  return (
    <>
      <Head>
        ...
        <title>Manufacturers of High-Quality Medical Uniforms | Athlotic Sports</title>
        <meta
          name="title"
          content="Manufacturers of High-Quality Medical Uniforms | Athlotic Sports"
        />
        <meta
          name="description"
          content="Leading manufacturers of top-tier medical uniforms for athletes. Explore our premium athletic sports apparel collection today."
        />
      ...
      <MainHeader pageHeading="Custom Medical Sports Uniform Supplier" />
