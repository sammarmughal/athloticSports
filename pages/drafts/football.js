...
export default function productDetailfitting() {
  let [categories] = useState({
    FOOTBALL: [
      {
        id: 1,
        name: "Football Uniform Sample Product 1",
        detail: "Customize Your \Football Dress and order in bulk",
        imageSrc: "/images/products/football/1.webp",
      ...
      {
        id: 2,
        name: "Football Uniform Sample Product 2",
        detail: "Customize Your \Football Dress and order in bulk",
        imageSrc: "/images/products/football/2.webp",
        imageAlt: "\Football Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 3,
        name: "Football Uniform Sample Product 3",
        detail: "Customize Your \Football Dress and order in bulk",
        imageSrc: "/images/products/football/3.webp",
        imageAlt: "\Football Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 4,
        name: "Football Uniform Sample Product 4",
        detail: "Customize Your \Football Dress and order in bulk",
        imageSrc: "/images/products/football/4.webp",
        imageAlt: "\Football Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 5,
        name: "Football Uniform Sample Product 5",
        detail: "Customize Your \Football Dress and order in bulk",
        imageSrc: "/images/products/football/5.webp",
        imageAlt: "\Football Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 6,
        name: "Football Uniform Sample Product 6",
        detail: "Customize Your \Football Dress and order in bulk",
        imageSrc: "/images/products/football/6.webp",
        imageAlt: "\Football Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 7,
        name: "Football Uniform Sample Product 7",
        detail: "Customize Your \Football Dress and order in bulk",
        imageSrc: "/images/products/football/7.webp",
        imageAlt: "\Football Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 8,
        name: "Football Uniform Sample Product 8",
        detail: "Customize Your \Football Dress and order in bulk",
        imageSrc: "/images/products/football/8.webp",
        imageAlt: "\Football Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 9,
        name: "Football Uniform Sample Product 9",
        detail: "Customize Your \Football Dress and order in bulk",
        imageSrc: "/images/products/football/9.webp",
        imageAlt: "\Football Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 10,
        name: "Football Uniform Sample Product 10",
        detail: "Customize Your \Football Dress and order in bulk",
        imageSrc: "/images/products/football/10.webp",
        imageAlt: "\Football Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 11,
        name: "Football Uniform Sample Product 11",
        detail: "Customize Your \Football Dress and order in bulk",
        imageSrc: "/images/products/football/11.webp",
        imageAlt: "\Football Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 12,
        name: "Football Uniform Sample Product 12",
        detail: "Customize Your \Football Dress and order in bulk",
        imageSrc: "/images/products/football/12.webp",
        imageAlt: "Football Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 13,
        name: "Football Uniform Sample Product 13",
        detail: "Customize Your Football Dress and order in bulk",
        imageSrc: "/images/products/football/13.webp",
        imageAlt: "Football Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 14,
        name: "Football Uniform Sample Product 14",
        detail: "Customize Your Football Dress and order in bulk",
        imageSrc: "/images/products/football/14.webp",
        imageAlt: "Football Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 15,
        name: "Football Uniform Sample Product 15",
        detail: "Customize Your Football Dress and order in bulk",
        imageSrc: "/images/products/football/15.webp",
        imageAlt: "Football Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 16,
        name: "Football Uniform Sample Product 16",
        detail: "Customize Your Football Dress and order in bulk",
        imageSrc: "/images/products/football/16.webp",
        imageAlt: "Football Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 17,
        name: "Football Uniform Sample Product 17",
        detail: "Customize Your Football Dress and order in bulk",
        imageSrc: "/images/products/football/17.webp",
        imageAlt: "Football Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 18,
        name: "Football Uniform Sample Product 18",
        detail: "Customize Your Football Dress and order in bulk",
        imageSrc: "/images/products/football/18.webp",
        imageAlt: "Football Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 19,
        name: "Football Uniform Sample Product 19",
        detail: "Customize Your Football Dress and order in bulk",
        imageSrc: "/images/products/football/19.webp",
        imageAlt: "Football Uniform",
        features: "High Quality Wear",
  ...
  return (
    <>
      <Head>
        ...
        <title>Manufacturers of High-Quality Football Uniforms | Athlotic Sports</title>
        <meta
          name="title"
          content="Manufacturers of High-Quality Football Uniforms | Athlotic Sports"
        />
        <meta
          name="description"
          content="Leading manufacturers of top-tier football uniforms for athletes. Explore our premium athletic sports apparel collection today."
        />
      ...
      <MainHeader pageHeading="Custom Football Sports Uniform Supplier" />
