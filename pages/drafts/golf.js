...
export default function productDetailfitting() {
  let [categories] = useState({
    GOLF: [
      {
        id: 1,
        name: "Golf Uniform Sample Product 1",
        detail: "Customize Your Golf Dress and order in bulk",
        imageSrc: "/images/products/golf/1.webp",
        imageAlt: "Golf Uniform",
        features: "High Quality Wear",

      },
      {
        id: 2,
        name: "Golf Uniform Sample Product 2",
        detail: "Customize Your Golf Dress and order in bulk",
        imageSrc: "/images/products/golf/2.webp",
        imageAlt: "Golf Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 3,
        name: "Golf Uniform Sample Product 3",
        detail: "Customize Your Golf Dress and order in bulk",
        imageSrc: "/images/products/golf/3.webp",
        imageAlt: "Golf Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 4,
        name: "Golf Uniform Sample Product 4",
        detail: "Customize Your Golf Dress and order in bulk",
        imageSrc: "/images/products/golf/4.webp",
        imageAlt: "Golf Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 5,
        name: "Golf Uniform Sample Product 5",
        detail: "Customize Your Golf Dress and order in bulk",
        imageSrc: "/images/products/golf/5.webp",
        imageAlt: "Golf Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 6,
        name: "Golf Uniform Sample Product 6",
        detail: "Customize Your Golf Dress and order in bulk",
        imageSrc: "/images/products/golf/6.webp",
        imageAlt: "Golf Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 7,
        name: "Golf Uniform Sample Product 7",
        detail: "Customize Your Golf Dress and order in bulk",
        imageSrc: "/images/products/golf/7.webp",
        imageAlt: "Golf Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 8,
        name: "Golf Uniform Sample Product 8",
        detail: "Customize Your Golf Dress and order in bulk",
        imageSrc: "/images/products/golf/8.webp",
        imageAlt: "Golf Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 9,
        name: "Golf Uniform Sample Product 9",
        detail: "Customize Your Golf Dress and order in bulk",
        imageSrc: "/images/products/golf/9.webp",
        imageAlt: "Golf Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 10,
        name: "Golf Uniform Sample Product 10",
        detail: "Customize Your Golf Dress and order in bulk",
        imageSrc: "/images/products/golf/10.webp",
        imageAlt: "Golf Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 11,
        name: "Golf Uniform Sample Product 11",
        detail: "Customize Your Golf Dress and order in bulk",
        imageSrc: "/images/products/golf/11.webp",
        imageAlt: "Golf Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 12,
        name: "Golf Uniform Sample Product 12",
        detail: "Customize Your Golf Dress and order in bulk",
        imageSrc: "/images/products/golf/12.webp",
        imageAlt: "Golf Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 13,
        name: "Golf Uniform Sample Product 13",
        detail: "Customize Your Golf Dress and order in bulk",
        imageSrc: "/images/products/golf/13.webp",
        imageAlt: "Golf Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 14,
        name: "Golf Uniform Sample Product 14",
        detail: "Customize Your Golf Dress and order in bulk",
        imageSrc: "/images/products/golf/14.webp",
        imageAlt: "Golf Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 15,
        name: "Golf Uniform Sample Product 15",
        detail: "Customize Your Golf Dress and order in bulk",
        imageSrc: "/images/products/golf/15.webp",
        imageAlt: "Golf Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 16,
        name: "Golf Uniform Sample Product 16",
        detail: "Customize Your Golf Dress and order in bulk",
        imageSrc: "/images/products/golf/16.webp",
        imageAlt: "Golf Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 17,
        name: "Golf Uniform Sample Product 17",
        detail: "Customize Your Golf Dress and order in bulk",
        imageSrc: "/images/products/golf/17.webp",
        imageAlt: "Golf Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 18,
        name: "Golf Uniform Sample Product 18",
        detail: "Customize Your Golf Dress and order in bulk",
        imageSrc: "/images/products/golf/18.webp",
        imageAlt: "Golf Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 19,
        name: "Golf Uniform Sample Product 19",
        detail: "Customize Your Golf Dress and order in bulk",
        imageSrc: "/images/products/golf/19.webp",
        imageAlt: "Golf Uniform",
        features: "High Quality Wear",
  ...
  return (
    <>
      <Head>
        ...
        <title>Manufacturers of High-Quality Golf Uniforms | Athlotic Sports</title>
        <meta
          name="title"
          content="Manufacturers of High-Quality Golf Uniforms | Athlotic Sports"
        />
        <meta
          name="description"
          content="Leading manufacturers of top-tier golf uniforms for athletes. Explore our premium athletic sports apparel collection today."
        />
        ...
        <link rel="canonical" href="https://athlotic.com/golf" />
        <link rel="preconnect" href="//www.google-analytics.com" as="script" />
        <meta name="google" content="notranslate" />
      </Head>

      <MainHeader pageHeading="Custom Golf Sports Uniform Supplier" />
