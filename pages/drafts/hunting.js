...
export default function productDetailfitting() {
  let [categories] = useState({
    HUNTING: [
      {
        id: 1,
        name: "Hunting Uniform Sample Product 1",
        detail: "Customize Your \Hunting Dress and order in bulk",
        imageSrc: "/images/products/hunting/1.webp",
        imageAlt: "\Hunting Uniform",
        features: "High Quality Wear",

      },
      {
        id: 2,
        name: "Hunting Uniform Sample Product 2",
        detail: "Customize Your \Hunting Dress and order in bulk",
        imageSrc: "/images/products/hunting/2.webp",
        imageAlt: "\Hunting Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 3,
        name: "Hunting Uniform Sample Product 3",
        detail: "Customize Your \Hunting Dress and order in bulk",
        imageSrc: "/images/products/hunting/3.webp",
        imageAlt: "\Hunting Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 4,
        name: "Hunting Uniform Sample Product 4",
        detail: "Customize Your \Hunting Dress and order in bulk",
        imageSrc: "/images/products/hunting/4.webp",
        imageAlt: "\Hunting Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 5,
        name: "Hunting Uniform Sample Product 5",
        detail: "Customize Your \Hunting Dress and order in bulk",
        imageSrc: "/images/products/hunting/5.webp",
        imageAlt: "\Hunting Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 6,
        name: "Hunting Uniform Sample Product 6",
        detail: "Customize Your \Hunting Dress and order in bulk",
        imageSrc: "/images/products/hunting/6.webp",
        imageAlt: "\Hunting Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 7,
        name: "Hunting Uniform Sample Product 7",
        detail: "Customize Your \Hunting Dress and order in bulk",
        imageSrc: "/images/products/hunting/7.webp",
        imageAlt: "\Hunting Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 8,
        name: "Hunting Uniform Sample Product 8",
        detail: "Customize Your \Hunting Dress and order in bulk",
        imageSrc: "/images/products/Hunting/8.webp",
        imageAlt: "\Hunting Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 9,
        name: "Hunting Uniform Sample Product 9",
        detail: "Customize Your \Hunting Dress and order in bulk",
        imageSrc: "/images/products/hunting/9.webp",
        imageAlt: "\Hunting Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 10,
        name: "Hunting Uniform Sample Product 10",
        detail: "Customize Your \Hunting Dress and order in bulk",
        imageSrc: "/images/products/hunting/10.webp",
        imageAlt: "\Hunting Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 11,
        name: "Hunting Uniform Sample Product 11",
        detail: "Customize Your \Hunting Dress and order in bulk",
        imageSrc: "/images/products/hunting/11.webp",
        imageAlt: "\Hunting Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 12,
        name: "Hunting Uniform Sample Product 12",
        detail: "Customize Your \Hunting Dress and order in bulk",
        imageSrc: "/images/products/hunting/12.webp",
        imageAlt: "Hunting Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 13,
        name: "Hunting Uniform Sample Product 13",
        detail: "Customize Your Hunting Dress and order in bulk",
        imageSrc: "/images/products/hunting/13.webp",
        imageAlt: "Hunting Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 14,
        name: "Hunting Uniform Sample Product 14",
        detail: "Customize Your Hunting Dress and order in bulk",
        imageSrc: "/images/products/hunting/14.webp",
        imageAlt: "Hunting Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 15,
        name: "Hunting Uniform Sample Product 15",
        detail: "Customize Your Hunting Dress and order in bulk",
        imageSrc: "/images/products/hunting/15.webp",
        imageAlt: "Hunting Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 16,
        name: "Hunting Uniform Sample Product 16",
        detail: "Customize Your Hunting Dress and order in bulk",
        imageSrc: "/images/products/hunting/16.webp",
        imageAlt: "Hunting Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 17,
        name: "Hunting Uniform Sample Product 17",
        detail: "Customize Your Hunting Dress and order in bulk",
        imageSrc: "/images/products/hunting/17.webp",
        imageAlt: "Hunting Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 18,
        name: "Hunting Uniform Sample Product 18",
        detail: "Customize Your Hunting Dress and order in bulk",
        imageSrc: "/images/products/hunting/18.webp",
        imageAlt: "Hunting Uniform",
        features: "High Quality Wear",
  ...
  return (
    <>
      <Head>
        ...
        <title>Manufacturers of High-Quality Hunting Uniforms | Athlotic Sports</title>
        <meta
          name="title"
          content="Manufacturers of High-Quality Hunting Uniforms | Athlotic Sports"
        />
        <meta
          name="description"
          content="Leading manufacturers of top-tier hunting uniforms for athletes. Explore our premium athletic sports apparel collection today."
        />
      ...
      <MainHeader pageHeading="Custom Hunting Sports Uniform Supplier" />
