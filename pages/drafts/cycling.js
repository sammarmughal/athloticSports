...
export default function productDetailfitting() {
  let [categories] = useState({
    CYCLING: [
      {
        id: 1,
        name: "Cycling Uniform Sample Product 1",
        detail: "Customize Your Cycling Dress and order in bulk",
        imageSrc: "/images/products/cycling/1.webp",
        imageAlt: "Cycling Uniform",
        features: "High Quality Wear",

      },
      {
        id: 2,
        name: "Cycling Uniform Sample Product 2",
        detail: "Customize Your Cycling Dress and order in bulk",
        imageSrc: "/images/products/cycling/2.webp",
        imageAlt: "Cycling Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 3,
        name: "Cycling Uniform Sample Product 3",
        detail: "Customize Your Cycling Dress and order in bulk",
        imageSrc: "/images/products/cycling/3.webp",
        imageAlt: "Cycling Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 4,
        name: "Cycling Uniform Sample Product 4",
        detail: "Customize Your Cycling Dress and order in bulk",
        imageSrc: "/images/products/cycling/4.webp",
        imageAlt: "Cycling Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 5,
        name: "Cycling Uniform Sample Product 5",
        detail: "Customize Your Cycling Dress and order in bulk",
        imageSrc: "/images/products/cycling/5.webp",
        imageAlt: "Cycling Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 6,
        name: "Cycling Uniform Sample Product 6",
        detail: "Customize Your Cycling Dress and order in bulk",
        imageSrc: "/images/products/cycling/6.webp",
        imageAlt: "Cycling Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 7,
        name: "Cycling Uniform Sample Product 7",
        detail: "Customize Your Cycling Dress and order in bulk",
        imageSrc: "/images/products/cycling/7.webp",
        imageAlt: "Cycling Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 8,
        name: "Cycling Uniform Sample Product 8",
        detail: "Customize Your Cycling Dress and order in bulk",
        imageSrc: "/images/products/cycling/8.webp",
        imageAlt: "Cycling Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 9,
        name: "Cycling Uniform Sample Product 9",
        detail: "Customize Your Cycling Dress and order in bulk",
        imageSrc: "/images/products/cycling/9.webp",
        imageAlt: "Cycling Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 10,
        name: "Cycling Uniform Sample Product 10",
        detail: "Customize Your Cycling Dress and order in bulk",
        imageSrc: "/images/products/cycling/10.webp",
        imageAlt: "Cycling Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 11,
        name: "Cycling Uniform Sample Product 11",
        detail: "Customize Your Cycling Dress and order in bulk",
        imageSrc: "/images/products/cycling/11.webp",
        imageAlt: "Cycling Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 12,
        name: "Cycling Uniform Sample Product 12",
        detail: "Customize Your Cycling Dress and order in bulk",
        imageSrc: "/images/products/cycling/12.webp",
        imageAlt: "Cycling Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 13,
        name: "Cycling Uniform Sample Product 13",
        detail: "Customize Your Cycling Dress and order in bulk",
        imageSrc: "/images/products/cycling/13.webp",
        imageAlt: "Cycling Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 14,
        name: "Cycling Uniform Sample Product 14",
        detail: "Customize Your Cycling Dress and order in bulk",
        imageSrc: "/images/products/cycling/14.webp",
        imageAlt: "Cycling Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 15,
        name: "Cycling Uniform Sample Product 15",
        detail: "Customize Your Cycling Dress and order in bulk",
        imageSrc: "/images/products/cycling/15.webp",
        imageAlt: "Cycling Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 16,
        name: "Cycling Uniform Sample Product 16",
        detail: "Customize Your Cycling Dress and order in bulk",
        imageSrc: "/images/products/cycling/16.webp",
        imageAlt: "Cycling Uniform",
        features: "High Quality Wear",
      ...
      {
        id: 17,
        name: "Cycling Uniform Sample Product 17",
        detail: "Customize Your Cycling Dress and order in bulk",
        imageSrc: "/images/products/cycling/17.webp",
        imageAlt: "Cycling Uniform",
        features: "High Quality Wear",
  ...
  return (
    <>
      <Head>
        ...
        <title>Manufacturers of High-Quality Cycling Uniforms | Athlotic Sports</title>
        <meta
          name="title"
          content="Manufacturers of High-Quality Cycling Uniforms | Athlotic Sports"
        />
        <meta
          name="description"
          content="Leading manufacturers of top-tier cycling uniforms for athletes. Explore our premium athletic sports apparel collection today."
        />
        ...
        <link rel="canonical" href="https://athlotic.com/cycling" />
        <link rel="preconnect" href="//www.google-analytics.com" as="script" />
        <meta name="google" content="notranslate" />
      </Head>

      <MainHeader pageHeading="Custom Cycling Sports Uniform Supplier" />
